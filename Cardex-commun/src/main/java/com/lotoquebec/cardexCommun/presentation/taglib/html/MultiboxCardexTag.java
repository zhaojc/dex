...
/**
 * Tag pour les input fields de type "checkbox".  Ceci differs du CheckboxTag
 * parce que il assume que la proprété est array getter (du n'importe quel
 * type primitifs supportés, ou un String), et le checkbox sont initialisés a
 * "checked" si les valeurs listées pour l'attribut value est présent à l'intérieur des
 * valeurs retourné pa la propriété getter.
 *
 * @see org.apache.struts.taglib.html.MultiboxTag
 * @author $Author: mlibersan $
 * @version $Revision: 1.4 $ $Date: 2002/03/11 22:23:25 $
 */
public class MultiboxCardexTag extends org.apache.struts.taglib.html.MultiboxTag {
