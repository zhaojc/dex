...
/**
 * Ce tag créer le input argent seulement
 * 
 ...
 */
public class ArgentTag  extends org.apache.struts.taglib.html.TextTag {
    ...
    private String obtenirOnFocusOut(){
    	return " onfocusout='validerArgent(this);' ";
    }
    ...
    private String obtenirOnKeyDown(){
    	...
    	onkeydown.append('"');
    	//On remplace le point par une virgule décimale, avant la validation du caractère saisi.
    	onkeydown.append("return isArgentTag(event.keyCode);"+'"'+" ");
