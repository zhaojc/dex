...
public final class GlobalConstants {
    ...
    public static class ChoixRapport{
    	public static final String ACCES_INTERVENANT ="CDX_0122_audit_acces_intervenant.jasper";
    	...
    	public static final String AUDIT_CHANGEMENTS_ADRESSES = "CDX_0180_audit_changements_adresses.jasper";
    	public static final String AUDIT_CHANGEMENTS_DOSSIERS = "CDX_0182_audit_changements_dossiers.jasper";
    	public static final String AUDIT_CHANGEMENTS_INTERVENANTS ="CDX_0183_audit_changements_intervenants.jasper";
    	public static final String AUDIT_CHANGEMENTS_NARRATIONS = "CDX_0181_audit_changements_narrations.jasper";
    	public static final String AUDIT_CHANGEMENTS_SOCIETES = "CDX_0184_audit_changements_societes.jasper";
    	public static final String AUDIT_CHANGEMENTS_SUJETS = "CDX_0185_audit_changements_sujets.jasper";
    	public static final String AUDIT_CHANGEMENTS_SUIVIS = "CDX_0186_audit_changements_suivis.jasper";
    	public static final String AUDIT_CHANGEMENTS_VEHICULES = "CDX_0187_audit_changements_vehicules.jasper";
    	public static final String AUDIT_ACCES_DOSSIERS = "CDX_0210_impression_audit_acces_dossiers.jasper";
    	public static final String AUDIT_ACCES_SUJETS = "CDX_0211_impression_audit_acces_sujets.jasper";
    	public static final String AUDIT_ACCES_SOCIETES = "CDX_0212_impression_audit_acces_societes.jasper";
    	public static final String AUDIT_ACCES_VEHICULES = "CDX_0213_impression_audit_acces_v�hicules.jasper";
    	public static final String DETAIL_ACCES_DOSSIERS ="CDX_0121_audit_detail_acces.jasper";
    	public static final String DETAIL_ACCES_INTERVENANT ="CDX_0123_audit_detail_acces_intervenant.jasper";
    	public static final String ECRAN = "ECRAN";
    	public static final String FICHIER = "FICHIER";
    	public static final String IMPRESSION_SUJET = "CDX_0002_sujet.jasper";
    	public static final String IMPRESSION_SOCIETE = "CDX_0003_societe.jasper";
    	public static final String IMPRESSION_DOSSIER = "dossier.jasper";
    	public static final String IMPRESSION_GALERIE = "CDX_0004_sujet-galerie.jasper";
    	public static final String JOURNAL_CATEGORIE = "rapport_journal_categorie.jasper";
    	public static final String JOURNAL_CATEGORIE_INTERVENANT = "rapport_journal_categorie_intervenant.jasper";
    	
    	
        public static final String MATRICE_GROUPES ="CDX_0170_matrice_roles_groupes.jasper";
        public static final String MATRICE_PROFILS ="CDX_0171_matrice_roles_profils.jasper";
        public static final String MATRICE_GROUPES_DESCRIPTION ="CDX_0172_matrice_roles_groupes_description.jasper";
    	...
    	public static final String REPERAGES_AVIS_DE_GUET = "CDX_0013_reperages_avis_guet.jasper";
    	public static final String SOMMAIRE_ACCES_DOSSIERS ="CDX_0120_audit_sommaire_acces.jasper";
    	public static final String RESULTATS_RECHERCHE_DOSSIERS = "CDX_0110_resultats_recherche_dossiers.jasper";
    	public static final String ONGLET_DOSSIERS_DOSSIER = "CDX_0114_liste_dossiers_onglet_dossiers_dossier.jasper";
    	public static final String ONGLET_DOSSIERS_SUJET = "CDX_0115_liste_dossiers_onglet_dossiers_sujet.jasper";
    	public static final String ONGLET_SUJET_SOCIETE = "CDX_0116_liste_sujets_onglet_sujets_soci�t�.jasper";
    	public static final String RESULTATS_RECHERCHE_DOSSIERS_COMPLET = "resultats_recherche_dossiers_complet.jasper";
    	public static final String RESULTATS_RECHERCHE_SUJETS = "CDX_0111_resultats_recherche_sujets.jasper";
    	public static final String RESULTATS_RECHERCHE_ADRESSE_SUJETS = "resultats_recherche_adresse_sujets.jasper";
    	public static final String RESULTATS_RECHERCHE_SUJETS_COMPLET = "resultats_recherche_sujets_complet.jasper";
    	public static final String RESULTATS_RECHERCHE_SOCIETES = "CDX_0112_resultats_recherche_societes.jasper";
    	public static final String RESULTATS_RECHERCHE_SOCIETES_COMPLET = "resultats_recherche_societes_complet.jasper";
    	public static final String RESULTATS_RECHERCHE_ADRESSE_SOCIETES = "resultats_recherche_adresse_societes.jasper";
    	public static final String RESULTATS_RECHERCHE_VEHICULES = "CDX_0113_resultats_recherche_vehicules.jasper";
    	public static final String RESULTATS_RECHERCHE_VEHICULES_COMPLET = "resultats_recherche_vehicules_complet.jasper";
        public static final String RESULTATS_RECHERCHE_URGENCE = "CDX_0272_resultats_recherche_service_urgence.jasper";
        public static final String RESULTATS_RECHERCHE_URGENCE_COMPLET = "resultats_recherche_service_urgence_complet.jasper";
    	public static final String RESULTATS_RECHERCHE_SUIVIS = "CDX_0096_resultats_recherche_suivis.jasper";
    	public static final String RESULTATS_RECHERCHE_MANDATS = "CDX_0190_resultat_recherche_mandats.jasper";
    	public static final String RESULTATS_RECHERCHE_GALERIE = "CDX_0201_impression_galerie.jasper";
    	public static final String CONSIGNATION_ACTIONS_MANDATS = "CDX_0191_historique_actions_mandats.jasper";
    	public static final String RESULTATS_RECHERCHE_CONSIGNATIONS = "CDX_0155_resultats_recherche_consignations.jasper";
    	public static final String IMPRESSION_INSCRIPTION = "CDX_0200_impression_inscription.jasper";
    	public static final String IMPRESSION_SUIVI = "CDX_0097_impression_suivi.jasper";
    	public static final String RESULTATS_RECHERCHE_DOSSIERS_AVEC_SUJETS = "CDX_0224_impression_dossiers_avec_sujets.jasper";
    	public static final String RESULTATS_RECHERCHE_DOSSIERS_SANS_SUJETS = "CDX_0225_impression_dossiers_sans_sujets.jasper";
    	public static final String IMPRESSION_DETAILLE_DOSSIER_VIGILANCE = "CDX_0233_rapport_vigilance_detaille.jasper";
    	public static final String IMPRESSION_SOMMAIRE_DOSSIER_VIGILANCE = "CDX_0232_rapport_vigilance_sommaire.jasper";
    	public static final String RAPPORT_ACCES_SUJETS = "CDX_0124_audit_acces_sujets.jasper";
    	public static final String RAPPORT_ACCES_SUJETS_FOURNISSEURS = "CDX_0125_audit_acces_sujets_fournisseurs.jasper";
    	public static final String RAPPORT_ACCES_NARRATIONS = "CDX_0126_audit_acces_narrations.jasper";
