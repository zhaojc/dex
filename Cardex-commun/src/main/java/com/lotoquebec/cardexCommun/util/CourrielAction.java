...
/**
 * Cette classe traite l'envoi automatique des courriers �lectroniques
 * aux intervenants concern�s par un mouvement de personnel.
 *
...
public class CourrielAction{
	...
	public static void envoiCourriel(CardexAuthenticationSubject subject, String codeExpediteur, String texte, String destinataire, String objet){
	       ...
	       try {
	    	   ...
	    	   log.debug("Envoi du courrier � : " + to);
...
/*
	...
	// On recherche tous les intervenants qui doivent �tre avis�s
	// en fonction du site d'o� origine le mouvement.
	// La table GI_GROUPE_INTERVENTION contient les appariements
	// entre les sites d'origine (concern�) et les intervenants (site
	// d'intervention).
