 ...
 * @author levassc
 */
public class IntervenantParEntiteCle extends CleSQLListeCache{

	public IntervenantParEntiteCle(String langue, String colonneDiscriminantValeur) {
		super(langue, colonneDiscriminantValeur);
		this.discriminantValeurRequis = true;
	}

	public IntervenantParEntiteCle(CardexAuthenticationSubject subject, String colonneDiscriminantValeur) {
	...
	public PreparerSQL getPreparerSQL() {
		...
		SQL.append("from in_intervenant i, tr_traduction tr, si_site s ");
		SQL.append("where i.i_st_cle = "+GlobalConstants.Statut.INTERVENANT_ACTIF+" ");
		SQL.append("and i.l_in_secteur = tr.l_tr_cle ");
		SQL.append("and s.l_si_cle = i.l_si_cle ");
		SQL.append("and S.I_EN_CLE = ? ");
