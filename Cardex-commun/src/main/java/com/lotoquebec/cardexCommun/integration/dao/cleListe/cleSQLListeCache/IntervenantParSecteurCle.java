 ...
 * @author levassc
 */
public class IntervenantParSecteurCle extends CleSQLListeCache{

	public IntervenantParSecteurCle(String langue, String colonneDiscriminantValeur) {
		super(langue, colonneDiscriminantValeur);
		this.discriminantValeurRequis = true;
	}

	public IntervenantParSecteurCle(CardexAuthenticationSubject subject, String colonneDiscriminantValeur) {
