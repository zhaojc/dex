 ...
 * @author levassc
 */
public class CodeAjoutTableValeurCleSQL extends CleSQLListeCache{

	public CodeAjoutTableValeurCleSQL(String langue, String colonneDiscriminantValeur) {
	...
	public PreparerSQL getPreparerSQL() {
		...
		SQL.append("where t.v_tv_code not in ('"+GlobalConstants.TableValeur.GENRE+"','"+GlobalConstants.TableValeur.NATURE+"') ");
