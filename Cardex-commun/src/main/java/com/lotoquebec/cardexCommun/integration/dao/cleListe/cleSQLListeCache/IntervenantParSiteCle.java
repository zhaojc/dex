 ...
 * @author levassc
 */
public class IntervenantParSiteCle extends CleSQLListeCache{

	public IntervenantParSiteCle(String langue, String colonneDiscriminantValeur) {
		super(langue, colonneDiscriminantValeur);
		discriminantValeurRequis = true;
	}
	
	public IntervenantParSiteCle(String langue, long colonneDiscriminantValeur) {
		super(langue, String.valueOf(colonneDiscriminantValeur));
		discriminantValeurRequis = true;
	}

	public IntervenantParSiteCle(CardexAuthenticationSubject subject, String colonneDiscriminantValeur) {
