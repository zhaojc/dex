...
/**
 * Offre tout les services d'utilit�s associ�s � la r�cup�ration de donn�e d'une
 * base de donn�e Oracle.
 *
...
public class OracleDAOUtils {
    ...
    private static final String CARACTERES_NON_NUMERIQUE = "/\\/-^�:.,;=#+()$_&*!@%+ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz����������������������������������";
	private static BigDecimal zeroBD = new BigDecimal("0.00");
    /**
     * Constructeur OracleDAOUtils par d�faut.
     */
    ...
    /**
    * Retourne une string sans les caract�res num�riques
    * @param s (string � manipuler)
    * @param parameterIndex
    * @throws SQLException
    */
    ...
    /**
     * Test d'une valeur nulle dans un crit�re de recherche de dossier.
     *
     * @param valeur
     * @return boolean
    ...
    /**
     * Conversion d'un CLOB de la base de donn�es en String.  Les champs de type
	...
	// C'est laid, mais c'est la seule fa�on de passer un array que j'ai trouv�
	...
	/**
	    * Ajoute un champ dans un SQL qui sera compar� � une valeur format�e sans aucun caract�re alphab�tique
	    * Les 4 premiers translate enl�vent les caract�res esp�ciaux (espace, /, \ et '
	    * Le dernier tranlate enl�ve les caract�res indentifi�s dans CARACTERES_NON_NUMERIQUE du champ de recherche.
	    * En plus, la valeur persist�e dans la BD sera aussi num�rique (appel de retirerCaracteresNonNumeriques)
	    * 
	    * @param preparerSQL (PreparerSQL � manipuler)
	    * @param champ (String qui repr�sente la colonne de la BD)
	    * @param valeur (String qui repr�sente la valeur � formater)
	    */
