...
then
    ...
    echo "CDX_DIFFERE <env> ${LQ_APP_NAME} <job> [ <params job> ]"
    exit 50000
fi
...
then
	...
	# echo "La job est : $LQ_SUB_IDJOB"
	# echo "Les parametres sont : $LQ_SUB_PARAMS"
else
...
# Nom du fichier Log
#
export LQ_SUB_LOG=${LQ_SUB_REP_LOGS}/CDX_DIFFERE-${LQ_SUB_IDJOB}-${LQ_SUB_DATE_SYS}_${LQ_SUB_HEURE_SYS}.log
...
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )"     >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )"     >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )     Commande Lancee: ${LQ_SUB_IDJOB}" >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )     Parametres     : ${LQ_SUB_PARAMS}" >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )" >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )" >> ${LQ_SUB_LOG}
echo >> ${LQ_SUB_LOG}
...
echo                                                 >> ${LQ_SUB_LOG}
echo                                                 >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )    Variables d'environnements "     >> ${LQ_SUB_LOG}
echo                                                 >> ${LQ_SUB_LOG}
echo                                                 >> ${LQ_SUB_LOG}
...
echo                                                 >> ${LQ_SUB_LOG}
echo                                                 >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )    Sorties de la commande "     >> ${LQ_SUB_LOG}
echo                                                 >> ${LQ_SUB_LOG}
echo                                                 >> ${LQ_SUB_LOG}
echo                                                 >> ${LQ_SUB_LOG}
...
# On lance la job
#
java -classpath ${LQ_SUB_CLASSPATH} com.lq.commun.differes.activemq.SoumettreDiffere ${LQ_SUB_ENVIRONNEMENT} ${LQ_APP_NAME} ${LQ_SUB_IDJOB} ${LQ_SUB_PARAMS} >> ${LQ_SUB_LOG} 2>&1
CODE_RETOUR=$?
...
echo                                                 >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )"      >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )       Code de retour: ${CODE_RETOUR}" >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )"              >> ${LQ_SUB_LOG}
echo "CDX_DIFFERE ( ${LQ_SUB_DATE_AFF_SYS} ${LQ_SUB_HEURE_AFF_SYS} )"              >> ${LQ_SUB_LOG}
echo                                                 >> ${LQ_SUB_LOG}
