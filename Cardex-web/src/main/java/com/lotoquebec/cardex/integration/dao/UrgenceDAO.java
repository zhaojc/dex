...
public class UrgenceDAO {
	...
	/**
	 * Routine pour traiter les ResultSet retourn�s par les recherches de service d'urgence.
	 ...
	 * "stored procedure".
	 * @return ArrayList : liste des services d'urgence trait�s.
	 */
    ...
    /**
	 * Recherche des services d'urgence � l'aide de crit�res de recherche.
	 ...
	 * non disponible, ou qu'un probl�me est survenu lors de l'ex�cution d'une
	 * "stored procedure".
	 * @return ValueListIterator : liste des servces d'urgence retourn�s par la recherche.
	 */
	...
	/**
	 * Appel de la m�thode editUrgence pour la cr�ation d'un service d'urgence
	 * Date de cr�ation : (2002-02-27)
	 * @author Philippe Caron
	 * @param subject CardexAuthenticationSubject : Donn�es nominatives sur
	 * l'utilisateur.
	 * @param urgence Urgence : Consignation saisie � l'�cran.
	 ...
	 */
		...
		/**
		 * Appel de la m�thode editUrgence pour la suppression d'un service d'urgence
		 * Date de cr�ation : (2002-02-27)
		 * @author Philippe Caron
		 * @param subject CardexAuthenticationSubject : Donn�es nominatives sur
		 * l'utilisateur.
	    ...
	    /**
	     * Appel de la m�thode editUrgence pour la mise � jour d'un service d'urgence
	     * Date de cr�ation : (2002-02-27)
	     * @author Philippe Caron
	     * @param subject CardexAuthenticationSubject : Donn�es nominatives sur
	     * l'utilisateur.
    	...
    	/**
         * Recherche des services d'urgence cr��s dans les deux derniers jours lors de
         * l'affichage de l'�cran de recherche des services d'urgence Proc�dure appel�e :
         * CARDEX_WEB_LIRE_DOC_TRI.SPW_L_UR_URGENCE Date de cr�ation : (2014-03-17)
         * 
         * @author mazzucr
         * @param subject
         *            CardexAuthenticationSubject : donn�es nominatives sur
         *            l'utilisateur
         * @param criteria
         *            CriteresRechercheUrgence : crit�res de recherche
         * @throws DAOException
         *             lanc�e lorsqu'une SQLException est re�ue lors d'une rupture
         *             de connexion avec la base de donn�es, ou que la table
         *             demand�e est non disponible, ou qu'un probl�me est survenu
         *             lors de l'ex�cution d'une "stored procedure".
         * @return ValueListIterator : une liste de services d'urgence retourn�s par la
         *         recherche.
         */
