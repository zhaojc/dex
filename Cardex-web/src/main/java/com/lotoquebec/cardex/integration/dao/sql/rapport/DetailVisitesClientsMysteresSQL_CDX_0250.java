 ...
 *
 */
public class DetailVisitesClientsMysteresSQL_CDX_0250{
	...
	public static PreparerSQL construireSQL(StatistiqueDossierRapportVO cumulatifDossierRapportVO) {
		...
		query.append(" and d.i_ca_cle <> " + GlobalConstants.CategorieClientMystere.ECHANTILLON); //On exclut la catégorie "Détaillants visités".
