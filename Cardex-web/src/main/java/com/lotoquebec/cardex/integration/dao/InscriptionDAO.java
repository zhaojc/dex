...
/**
 * Liste des appels � la base de donn�es pour diff�rents acc�s aux dossiers.
 * L'inscription sont li�s aux dossiers.  Impl�mente l'interface InscriptionDAO.
 *
...
public class InscriptionDAO {
     ...
     * @param subject CardexAuthenticationSubject : Donn�es nominatives sur
     * l'utilisateur.
     * @param inscription Inscription : Inscription saisies � l'�cran.
    ...
    /**
     * Lecture des inscriptions associ�es � un dossier.
     * Proc�dure appel�e : CARDEX_WEB_LIRE_DOC_TRI.SPW_L_IS_INSCRIPTION
     * Date de cr�ation : (2002-03-04)
     * @author Philippe Caron
     * @param subject  CardexAuthenticationSubject : Donn�es nominatives sur
     * l'utilisateur.
     ...
     * Proc�dure appel�e : CARDEX_WEB_LIRE_DOC_TRI.SPW_L2_IS_INSCRIPTION
     * Date de cr�ation : (2002-03-04)
     * @author Philippe Caron
     * @param subject  CardexAuthenticationSubject : Donn�es nominatives sur
     * l'utilisateur.
