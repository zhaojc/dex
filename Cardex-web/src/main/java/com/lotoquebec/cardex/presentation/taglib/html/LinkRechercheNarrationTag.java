...
public class LinkRechercheNarrationTag extends LinkCardexTag {
	...
	return (SKIP_BODY);
      ...
      pageContext.setAttribute("narration.recherche.parameters",parameters);
      Map params = tagUtils.computeParameters
          (pageContext, paramId, paramName, paramProperty, paramScope,
           "narration.recherche.parameters", property, scope, transaction);
