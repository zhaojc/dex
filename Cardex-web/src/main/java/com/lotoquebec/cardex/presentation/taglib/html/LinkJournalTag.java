 ...
 */
public class LinkJournalTag extends LinkCardexTag {
    ...
    public int doStartTag() throws JspException {
		...
		UIComponentState state = null;
	  	...
	  	JournalHtmlForm dossierBean = null;
      ...
      if (dossier != null ) {
        ...
        if (dossierProperty != null) {
          try {
              ...
              if (bean == null){
                JspException e = new JspException("Unable to find under bean name '"+dossier+"' and under property'"+dossierProperty+"'in LinkJournalTag.");
                tagUtils.saveException(pageContext, e);
                throw e;
              }
        ...
        if (bean instanceof  JournalHtmlForm){
            dossierBean = (JournalHtmlForm)bean;
            ...
            pageContext.setAttribute("dossier.recherche.parameters",parameters);
              ...
              JspException e = new JspException("Invalid type '"+bean.getClass().getName()+"' for bean name '"+name+"' in LinkDossierTag, the bean type must be '"+JournalHtmlForm.class.getName()+"'.");
              tagUtils.saveException(pageContext, e);
              throw e;
        }
      }
