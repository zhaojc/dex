...
public class LinkRechercheSuiviTag  extends LinkCardexTag {
	...
	return (SKIP_BODY);
      ...
      pageContext.setAttribute("suivi.recherche.parameters",parameters);
      Map params = tagUtils.computeParameters
          (pageContext, paramId, paramName, paramProperty, paramScope,
           "suivi.recherche.parameters", property, scope, transaction);
