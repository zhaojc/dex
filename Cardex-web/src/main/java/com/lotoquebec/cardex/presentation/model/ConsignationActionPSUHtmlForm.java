...
public interface ConsignationActionPSUHtmlForm {
     ...
     *
     * @return String Valeur de l'entité en caractère en caractère.
     */
     ...
     *
     * @return String Valeur de la date de l'action en caractère.
     */
   ...
   /**
     ...
     *
     * @return String Valeur de la date du courriel en caractère.
     */
