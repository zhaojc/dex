 ...
 * avec le cas d'utilisation gestion des �valuations du comit� de vigilance.
 *
...
public class EvaluationAction extends AbstractAction {
    ...
    public ActionForward create(CardexAuthenticationSubject subject,
                                ...
                                ServletException {
        log.debug("Cr�ation d'une nouvelle �valuation");
        ...
        try{
	        if (form instanceof DossierForm) {
	          log.debug("Cr�ation d'une �valuation li�e au dossier: " + form);
	        ...
	        log.debug("�valuation : " + evaluationForm);
    ...
    /**
     * Ajout d'une fr�quence de visites dans l'�cran d'�valuation
     * 
     * @param mapping L' ActionMapping utils� pour s�lectionner cette instance
     * @param actionForm L'ActionForm bean pour cette requ�te (optionnelle)
     * @param request La requ�te HTTP trait�e
    ...
    HttpServletResponse response) throws IOException,
    ServletException {
        log.debug("Ajout d'une nouvelle fr�quence de visite");
        EvaluationForm evaluationForm = (EvaluationForm)form;
    ...
    /**
     * Retrait d'une fr�quence de visites dans l'�cran d'�valuation
     * 
     * @param mapping L' ActionMapping utils� pour s�lectionner cette instance
     * @param actionForm L'ActionForm bean pour cette requ�te (optionnelle)
     * @param request La requ�te HTTP trait�e
    ...
    HttpServletResponse response) throws IOException,
    ServletException {
        log.debug("Retrait d'une nouvelle fr�quence de visite");
        EvaluationForm evaluationForm = (EvaluationForm)form;
        int indexMise = Integer.valueOf(evaluationForm.getIndexMise());
    ...
    ServletException, BusinessResourceException {
        ...
        //Cr�ation d'une liste vide pour les fr�quences de visite
