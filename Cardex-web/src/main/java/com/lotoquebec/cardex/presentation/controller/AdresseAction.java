...
public class AdresseAction extends AbstractAction {
    ...
    public ActionForward ajouter(CardexAuthenticationSubject subject,
                                ...
                                ServletException {
        log.debug("Cr�ation d'une nouvelle adresse");

         AdresseForm adresseForm = new AdresseForm();
         
		  if (form instanceof SujetForm) {
		    log.debug("Cr�ation d'une adresse li�e au sujet: " + form);
		    ...
		    log.debug("Cr�ation d'une adresse li�e a la societe: " + form);
    ...
    /**
     * Validation de l'adresse, cette m�thode est appel� � l'entr� de la validation
     * @param subject
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * Valider l'adresse retourn� par la validation de l'adresse
     * @param subject
     * @param mapping
     * @param form
     * @param request
    ...
    /**
     * Transf�rer l'adresse � l'�cran de confirmation de l'adresse
     * @param subject
     * @param mapping
     * @param form
     * @param request
    ...
    public ActionForward choisirRechercher(CardexAuthenticationSubject subject,
			ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws IOException, ServletException {
		log.debug("Choix d'une adresse touv�e.");
		ActionMessages errors = new ActionMessages();
