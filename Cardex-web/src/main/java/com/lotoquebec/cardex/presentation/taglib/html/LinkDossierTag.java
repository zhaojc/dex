 ...
 */
public class LinkDossierTag extends LinkCardexTag {
    ...
    public int doStartTag() throws JspException {
		...
		if (dossier != null ) {
	        ...
	        if (bean instanceof  DossierHtmlForm){
	            ...
	            state = GestionnaireSecuriteCardex.obtenirURLUIComponentState(subject, pageContext.getSession(), dossierVO, Arrays.asList((SecuritePredicate)new IntervenantEstAssigne()), actionSecurite);
