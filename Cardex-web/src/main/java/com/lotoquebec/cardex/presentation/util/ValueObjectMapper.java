...
/**
 * M�thodes utilitaires pour convertir(mettre en correspondance)
...
public class ValueObjectMapper {
    ...
    /**
     * Constructeur de ValueObjectMapper par d�faut.
     */
    ...
    /**
     * Convertis une structure Dossier repr�sentant le dossier dans le model
     * d'affaire de l'application, en une structure DossierHtmlForm,
     * repr�sentant les informations du formulaire de dossier.
     *
    ...
    public static void convertDossier(Dossier dossier, DossierForm form,
        ...
        try {
            ...
            // Les attributs suivants doivent �tre retir�s du map, puisqu'ils
            // sont des types complexes (NumeroCardex et Timestamp) et qu'ils
            // ne peuvent �tre convertis par la m�thode "populate" de BeanUtils.
    ...
    /**
     * Convertis une structure FrequenceVisites repr�sentant le dossier dans le model
    ...
    /**
     * Convertis une structure Consignation repr�sentant le dossier dans le model
     * d'affaire de l'application, en une structure ConsignationHtmlForm,
     * repr�sentant les informations du formulaire de Consignation.
     *
    ...
    /**
     * Convertis une structure Journal repr�sentant le dossier dans le model
    ...
    /**
     * Convertis une structure Sujet repr�sentant le sujet dans le model
     * d'affaire de l'application, en une structure SujetHtmlForm,
     * repr�sentant les informations du formulaire de sujet.
     *
    ...
    public static void convertSujet(Sujet sujet, SujetHtmlForm form,
        ...
        try {
            ...
            // L'attributs suivant doivt �tre retir� du map, puisqu'il
            // est un type complexe (Timestamp) et qu'il ne peut �tre converti
            // par la m�thode "populate" de BeanUtils.
          ...
          //log.debug("Sujet converti � HTML : " + form.toString());
            form.setDateNaissance(TimestampFormat.format(
                    sujet.getDateNaissance(), locale, false));
    ...
    /**
     * Convertis une structure Narration repr�sentant la narration dans le
     * model d'affaire de l'application, en une structure NarrationHtmlForm,
     * repr�sentant les informations du formulaire de la narration.
     *
    ...
    /**
     * Convertis une structure Photo repr�sentant la photo dans le
     * model d'affaire de l'application, en une structure PhotoHtmlForm,
     * repr�sentant les informations du formulaire de la photo.
     *
    ...
    public static void convertPhoto(Photo photo, PhotoHtmlForm form,
        ...
        try {
            ...
            // L'attributs suivant doit �tre retir� du map, puisqu'il
            // est un type complexe (Timestamp) et qu'il ne peut �tre converti
            // par la m�thode "populate" de BeanUtils.
            map.remove("dateCreation");
            map.remove("cardex01");
...
/*
    ...
    /**
     * Convertis une structure Societe repr�sentant la soci�t� dans le
     * model d'affaire de l'application, en une structure SocieteHtmlForm,
     * repr�sentant les informations du formulaire de la soci�t�.
     *
     * @param soci�t� Structure contenant les informations de la soci�t�.
     * @param form Structure contenant les informations relative au formulaire
     * de la soci�t�.
     */
    ...
    /**
     * Convertis une structure Suivi repr�sentant le suivi dans le
     * model d'affaire de l'application, en une structure SuiviHtmlForm,
     * repr�sentant les informations du formulaire du suivi.
     *
    ...
    /**
     * Convertis une structure Acces repr�sentant Acces dans le
     * model d'affaire de l'application, en une structure AccesHtmlForm,
     * repr�sentant les informations sur les acc�s.
     *
     * @param acces Structure contenant les informations des acc�s.
     * @param form Structure contenant les informations relative � la liste
     * des acc�s.
     */
    ...
    /**
     * Convertis une structure Adresse repr�sentant l'adresse dans le
     * model d'affaire de l'application, en une structure AdresseHtmlForm,
     * repr�sentant les informations du formulaire de l'adresse.
     *
    ...
    /**
     * Convertis une structure Caracteristiques repr�sentant les
     * caract�ristiques dans le model d'affaire de l'application, en une
     * structure CaracteristiquesHtmlForm, repr�sentant les informations du
     * formulaire des caract�ristiques.
     *
    ...
    public static void convertCaracteristiques(CardexAuthenticationSubject subject, Caracteristiques caracteristiques,
        ...
        try {
            ...
            // L'attributs suivant doivt �tre retir� du map, puisqu'il
            // est un type complexe (ArrayList) et qu'il ne peut �tre converti
            // par la m�thode "populate" de BeanUtils.
     ...
     * structure PartageHtmlForm, repr�sentant les informations de l'onglet Partage.
     *
     * @param caracteristiques Structure contenant les informations des
     * caract�ristiques.
     * @param form Structure contenant les informations relative au formulaire
    ...
    /**
     * Convertis une structure Inscription repr�sentant l'inscription dans le
     * model d'affaire de l'application, en une structure InscriptionHtmlForm,
     * repr�sentant les informations du formulaire de l'inscription.
     *
    ...
    /**
     * Convertis une structure Jeux repr�sentant les jeux dans le
     * model d'affaire de l'application, en une structure JeuxHtmlForm,
     * repr�sentant les informations du formulaire de jeux.
     *
    ...
    /**
     * Convertis une structure Particularites repr�sentant les particularit�s
     * dans le model d'affaire de l'application, en une structure
     * ParticularitesHtmlForm, repr�sentant les informations du formulaire des
     * particularit�s.
     *
    ...
    /**
     * Convertis une structure CriteresRechercheDossier repr�sentant le dossier
     * recherch� dans le model d'affaire de l'application, en une structure
     * CriteresRechercheDossierHtmlForm, repr�sentant les informations du
    ...
    /**
     * Convertis une structure CriteresRechercheSujet repr�sentant le sujet
     * recherch� dans le model d'affaire de l'application, en une structure
     * CriteresRechercheSujetHtmlForm, repr�sentant les informations du
    ...
    /**
     * Convertis une structure CriteresRechercheNarration repr�sentant la
     * narration recherch�e dans le model d'affaire de l'application, en une
     * structure CriteresRechercheNarrationHtmlForm, repr�sentant les
    ...
    /**
     * Convertis une structure CriteresRecherchePhoto repr�sentant la
     * photo recherch�e dans le model d'affaire de l'application, en une
     * structure CriteresRecherchePhotoHtmlForm, repr�sentant les
    ...
    /**
     * Convertis une structure CriteresRechercheSociete repr�sentant la
     * soci�t� recherch�e dans le model d'affaire de l'application, en une
     * structure CriteresRechercheSocieteHtmlForm, repr�sentant les
     * informations du formulaire de recherche de la soci�t�.
     *
     * @param criteresSociete Structure contenant les informations de la soci�t�
     * recherch�e.
     * @param form Structure contenant les informations relative au formulaire
     * de recherche de la soci�t�.
     */
    ...
    /**
     * Convertis une structure CriteresRechercheSuivi repr�sentant le
     * suivi recherch� dans le model d'affaire de l'application, en une
     * structure CriteresRechercheSuiviHtmlForm, repr�sentant les
    ...
    /**
     * Convertis une structure convertCriteresRechercheConsignation repr�sentant le
     * suivi recherch� dans le model d'affaire de l'application, en une
     * structure CriteresRechercheConsignationHtmlForm, repr�sentant les
    ...
    /**
     * Convertis une structure DossierHtmlForm, repr�sentant les informations
     * du formulaire de dossier, en une structure Dossier repr�sentant le
    ...
    /**
     * Convertis une structure FrequenceVisitesHtmlForm, repr�sentant les informations
     * du formulaire de FrequenceVisites, en une structure FrequenceVisites repr�sentant le
     * FrequenceVisites dans le mod�le d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * d'�valuation.
    ...
    /**
     * Convertis une structure JournalHtmlForm, repr�sentant les informations
     * du formulaire de dossier, en une structure Journal repr�sentant le
     * dossier dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de dossier.
    ...
    /**
     * Convertis une structure SujetHtmlForm, repr�sentant les informations
     * du formulaire de sujet, en une structure Sujet repr�sentant le
    ...
    /**
     * Convertis une structure NarrationHtmlForm, repr�sentant les informations
     * du formulaire de narration, en une structure Narration repr�sentant la
    ...
    /**
     * Convertis une structure PhotoHtmlForm, repr�sentant les informations
     * du formulaire de photo, en une structure Photo repr�sentant la
    ...
    /**
     * Convertis une structure SocieteHtmlForm, repr�sentant les informations
     * du formulaire de soci�t�, en une structure Societe repr�sentant la
     * soci�t� dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de soci�t�.
     * @param societe Structure contenant les informations de la soci�t�.
     */
    ...
    /**
     * Convertis une structure SuiviHtmlForm, repr�sentant les informations
     * du formulaire de suivi, en une structure Suivi repr�sentant le
    ...
    /**
     * Convertis une structure AccesHtmlForm, repr�sentant les informations
     * du formulaire des acc�s, en une structure Acces repr�sentant
     * acces dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative � la liste
     * des acc�s
     * @param acces Structure contenant les informations des acc�es.
     */
    ...
    /**
     * Convertis une structure AdresseHtmlForm, repr�sentant les informations
     * du formulaire de l'adresse, en une structure Adresse repr�sentant
    ...
    /**
     * Convertis une structure CaracteristiquesHtmlForm, repr�sentant les
     * informations du formulaire des carat�ristiques, en une structure
     * Caracteristiques repr�sentant les caract�ristiques dans le model
    ...
    /**
     * Convertis une structure PartageHtmlForm, repr�sentant les
    ...
    /**
     * Convertis une structure InscriptionHtmlForm, repr�sentant les
     * informations du formulaire de l'inscription, en une structure
     * Inscription repr�sentant l'inscription dans le model d'affaire de
     * l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de l'inscription.
    ...
    /**
     * Convertis une structure JeuxHtmlForm, repr�sentant les informations du
     * formulaire des jeux, en une structure Jeux repr�sentant l'inscription
    ...
    /**
     * Convertis une structure ParticularitesHtmlForm, repr�sentant les
     * informations du formulaire des particularti�s, en une structure
     * Particularites repr�sentant les particularit�s dans le model d'affaire
     * de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * des particularit�s.
    ...
    /**
     * Convertis une structure CriteresRechercheDossierHtmlForm, repr�sentant
     * les informations du formulaire de recherche de dossier, en une structure
     * CriteresRechercheDossier repr�sentant le dossier recherch� dans le model
     * d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de recherche de dossier.
     * @param dossier Structure contenant les informations du dossier recherch�.
     */
	...
	/**
	 * Convertis une structure CriteresRechercheRegroupementHtmlForm, repr�sentant
	 * les informations du formulaire de recherche du journal, en une structure
	 * CriteresRechercheJournal repr�sentant le dossier recherch� dans le model
	 * d'affaire de l'application.
	 *
	 * @param form Structure contenant les informations relative au formulaire
	 * de recherche de dossier.
	...
	/**
	 * Convertis une structure CriteresRechercheJournal repr�sentant le dossier
	 * recherch� dans le model d'affaire de l'application, en une structure
	 * CriteresRechercheJournalHtmlForm, repr�sentant les informations du
	 * formulaire de recherche de dossier.
	 *
	 * @param criteresDossier Structure contenant les informations du dossier
	 * recherch�.
    ...
    /**
     * Convertis une structure CriteresRechercheSujetHtmlForm, repr�sentant
     * les informations du formulaire de recherche de sujet, en une structure
     * CriteresRechercheSujet repr�sentant le sujet recherch� dans le model
     * d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de recherche de sujet.
     * @param dossier Structure contenant les informations du sujet recherch�.
     */
    ...
    /**
     * Convertis une structure CriteresRechercheNarrationHtmlForm, repr�sentant
     * les informations du formulaire de recherche de narration, en une
     * structure CriteresRechercheNarration repr�sentant la narration recherch�
     * dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de recherche de la narration.
    ...
    /**
     * Convertis une structure CriteresRecherchePhotoHtmlForm, repr�sentant
     * les informations du formulaire de recherche de photo, en une
     * structure CriteresRecherchePhoto repr�sentant la photo recherch� dans
    ...
    /**
     * Convertis une structure CriteresRechercheSocieteHtmlForm, repr�sentant
     * les informations du formulaire de recherche de soci�t�, en une
     * structure CriteresRechercheSociete repr�sentant la soci�t� recherch�e
     * dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de recherche de la soci�t�.
    ...
    /**
     * Convertis une structure CriteresRechercheSuiviHtmlForm, repr�sentant
     * les informations du formulaire de recherche de suivi, en une
     * structure CriteresRechercheSuivi repr�sentant la suivi recherch�
     * dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de recherche du suivi.
    ...
    /**
     * Convertis une structure CriteresRechercheConsignationHtmlForm, repr�sentant
     * les informations du formulaire de recherche de Consignation, en une
     * structure CriteresRechercheConsignation repr�sentant la Consignation recherch�e
     * dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de recherche de Consignation.
    ...
    /**
     * Convertis une structure CriteresRechercheVehicule repr�sentant le v�hicule
     * recherch� dans le model d'affaire de l'application, en une structure
     * CriteresRechercheVehiculeHtmlForm, repr�sentant les informations du
     * formulaire de recherche de v�hicule.
     *
     * @param criteresVehicule Structure contenant les informations du v�hicule
     * recherch�.
     * @param form Structure contenant les informations relative au formulaire
     * de recherche de v�hicule.
     */
    ...
    /**
     * Convertis une structure CriteresRechercheVehiculeHtmlForm, repr�sentant
     * les informations du formulaire de recherche de v�hicule, en une structure
     * CriteresRechercheVehicule repr�sentant le v�hicule recherch� dans le mod�le
     * d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de recherche de sujet.
     * @param criteresVehicule Structure contenant les informations du sujet recherch�.
     */
    ...
    /**
     * Convertis une structure CriteresRechercheUrgenceHtmlForm, repr�sentant
     * les informations du formulaire de recherche du service d'urgence, en une structure
     * CriteresRechercheUrgence repr�sentant le service d'urgence recherch� dans le mod�le
     * d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de recherche du service d'urgence.
     * @param criteresUrgence Structure contenant les informations du service d'urgence recherch�.
     */
    ...
    /**
     * Convertis une structure V�hicule repr�sentant le v�hicule dans le model
     * d'affaire de l'application, en une structure VehiculeHtmlForm,
     * repr�sentant les informations du formulaire de v�hicule.
     *
     * @param vehicule Structure contenant les informations du v�hicule.
     * @param form Structure contenant les informations relative au formulaire
     * de v�hicule.
     */
   ...
   /**
     * Convertis une structure VehiculeHtmlForm, repr�sentant les informations
     * du formulaire de v�hicule, en une structure Vehicule repr�sentant le
     * v�hicule dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * de v�hicule.
	...
	public static void convertPSUMandatHtmlForm(PSUMandatHtmlForm form, PSUMandat psuMandat,
		...
		try {
			...
			map.remove("dateDebut");
			map.remove("dateFin");
			//Pour une raison inxepliqu�e, "servlet" est associ� � psuMandat, ce qui
	...
	/**
	 * Convertis une structure ConsignationAction repr�sentant le dossier dans le model
	...
	/**
	 * Convertis une structure ConsignationActionPSUHtmlForm, repr�sentant les informations
	 * du formulaire de suivi, en une structure ConsignationActionPSU repr�sentant le
	 * suivi dans le model d'affaire de l'application.
	 *
	 * @param form Structure contenant les informations relative au formulaire
	 * de suivi.
    ...
    /**
     * Convertit une structure EvaluationHtmlForm, repr�sentant les informations
     * du formulaire d'�valuation, en une structure Evaluation repr�sentant le
     * dossier dans le model d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
     * d'�valuaiton du Comit� de vigilance.
     * @param dossier Structure contenant les informations du dossier.
     */
    ...
    /**
     * Convertit une structure Evaluation repr�sentant l'�valuation dans le
     * model d'affaire de l'application, en une structure EvaluationHtmlForm,
     * repr�sentant les informations du formulaire d'�valuation.
     *
     * @param suivi Structure contenant les informations de l'�valuation.
     * @param form Structure contenant les informations relative au formulaire
     * du suivi.
     */
    ...
    /**
     * Convertis une structure Urgence repr�sentant le service d'urgence dans le
     * model d'affaire de l'application, en une structure UrgenceHtmlForm,
     * repr�sentant les informations du formulaire de service d'urgence.
     *
    ...
    /**
     * Convertis une structure UrgenceHtmlForm, repr�sentant les informations
     * du formulaire de l'adresse, en une structure Urgence repr�sentant
     * l'urgence dans le mod�le d'affaire de l'application.
     *
     * @param form Structure contenant les informations relative au formulaire
