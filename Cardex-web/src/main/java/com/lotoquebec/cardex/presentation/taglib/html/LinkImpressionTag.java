 ...
 */
public class LinkImpressionTag extends LinkCardexTag {
    ...
    public int doStartTag() throws JspException {
      ...
      if (object != null ) {
        ...
        if (bean == null) {
            JspException e = new JspException("Unable to find bean name '"+name+"' in LinkImpressionTag.");
        ...
        if (objectProperty != null) {
          try {
              ...
              if (bean == null){
                JspException e = new JspException("Unable to find under bean name '"+object+"' and under property'"+objectProperty+"'in LinkImpressionTag.");
                tagUtils.saveException(pageContext, e);
                throw e;
              }
          } catch (IllegalAccessException e) {
              throw new JspException("IllegalAccess in the LinkImpressionTag for the property");
          } catch (InvocationTargetException e) {
              Throwable t = e.getTargetException();
              throw new JspException("NoSuchMethodException in the LinkImpressionTag for the property:" + t.toString());
          } catch (NoSuchMethodException e) {
              throw new JspException("NoSuchMethodException in the LinkImpressionTag for the property");
          }
        }
