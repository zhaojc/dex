...
public class RapportAssociation {
	...
	public static GenererRapport obtenirGenererRapport(int choixRapport){
		...
		switch(choixRapport){
			...
			case 170: //Global des regroupements (heures travaill�es)
			...
			case 172: //Regroupement par intervenant tri� par endroit
			...
			case 493: //Rapport sur le nombre de dossiers retourn�s par une recherche
				return new NombreDossiers();
			case 550: //Formulaire de r�admission
				return new DossierReadmission();
				
			default:
				throw new RuntimeException("Aucun rapport trouv� pour la valeur "+choixRapport);		
		}
	}
	...
	public static String obtenirFichierJasper(int choixRapport){
		...
		switch(choixRapport){
			...
			case 127: // Rep�rages des avis de guet
				return GlobalConstants.ChoixRapport.REPERAGES_AVIS_DE_GUET;
			case 128: // Statistique des dossiers et cat�gories
