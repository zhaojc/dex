...
//Rapport CDX_0229 pour conna�tre le nombre de dossiers retourn�s par des crit�res de recherche
/**
...
public class NombreDossiers extends RechercheDossierRapport {
	...
	protected int produireRapport(CardexAuthenticationSubject subject,
		...
		//On calcule le nombre de dossiers retourn�s par les crit�res inscrits � l'�cran.
