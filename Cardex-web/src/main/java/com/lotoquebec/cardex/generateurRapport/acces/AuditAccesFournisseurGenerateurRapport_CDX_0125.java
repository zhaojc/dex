...
public class AuditAccesFournisseurGenerateurRapport_CDX_0125 extends CritereGenererRapport {

	@Override
	public void validerSecurite(CardexAuthenticationSubject subject) {
		GestionnaireSecurite.validerSecuriteURL(subject, "/rapport/auditAccesFournisseur");
	}
