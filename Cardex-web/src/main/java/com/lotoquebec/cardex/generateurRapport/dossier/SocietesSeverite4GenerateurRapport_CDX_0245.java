...
public class SocietesSeverite4GenerateurRapport_CDX_0245 extends CritereGenererRapport {

	@Override
	public void validerSecurite(CardexAuthenticationSubject subject) {
		GestionnaireSecurite.validerSecuriteURL(subject, "/rapport/societesSeverite4");
	}
	...
	public JRDataSource construireDataSource(CardexAuthenticationSubject subject, CritereRapportVO rapportVO, Connection connection) throws BusinessResourceException, BusinessException {
    	...
    	SeveriteRapportVO severiteRapportVO = (SeveriteRapportVO) rapportVO;
       	ResultSet resultSet = delegate.rapportSeverite(severiteRapportVO, "CARDEX_RAPPORT.SP_RAP_SEVERITE_4_SOCIETE",connection);
		return new JRResultSetDataSource(resultSet);
	}

	@Override
	protected InputStream obtenirGabarit() {
		return RapportsConfiguration.class.getResourceAsStream(RapportsConfiguration.SOCIETES_SEVERITE_4);
	}
