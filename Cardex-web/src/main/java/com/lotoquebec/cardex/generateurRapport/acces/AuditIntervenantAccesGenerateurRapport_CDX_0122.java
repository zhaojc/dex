...
public class AuditIntervenantAccesGenerateurRapport_CDX_0122 extends CritereGenererRapport {

	@Override
	public void validerSecurite(CardexAuthenticationSubject subject) {
		GestionnaireSecurite.validerSecuriteURL(subject, "/rapport/auditIntervenantAcces");
	}
	...
	public JRDataSource construireDataSource(CardexAuthenticationSubject subject, CritereRapportVO rapportVO, Connection connection) throws BusinessResourceException, BusinessException {
		...
		ResultSet resultSet = delegate.auditAccesIntervenant(rapportDossierVO,connection);
	...
	protected Map construireParametres(CardexAuthenticationSubject subject, VO rapportVO, Connection connection) throws JRException {
        ...
        parameters.put("TITRE","Rapport des acc�s par intervenant");
