...
public abstract class RechercheDossierRapport extends CritereGenererRapport {
	...
	public JasperPrint executer(CardexAuthenticationSubject subject, HttpServletRequest request) throws BusinessException, JRException {
		...
		//On s'assure qu'il y a des dates pour les rapports. Sinon, on prend la derni�re semaine.
	...
	private Map construireParametres(CardexAuthenticationSubject subject, Map parameterMap) {
		...
		//On ajoute les param�tres qui seront affich�s dans l'en-t�te du rapport.
