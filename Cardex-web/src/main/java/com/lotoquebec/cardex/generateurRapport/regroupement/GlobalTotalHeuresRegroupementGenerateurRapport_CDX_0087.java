...
public class GlobalTotalHeuresRegroupementGenerateurRapport_CDX_0087 extends RegroupementGenerateurRapport {

	protected InputStream obtenirGabarit() {
		return RapportsConfiguration.class.getResourceAsStream(RapportsConfiguration.RAPPORT_GLOBAL_REGROUPEMENTS_HEURES);
	}
	...
	public void validerSecurite(CardexAuthenticationSubject subject) {
		GestionnaireSecurite.validerSecuriteURL(subject, "/rapport/regroupementGlobalTotalHeures");
	}
