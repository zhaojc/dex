...
public class NumeroReperageAccesInterditsGenerateurRapport_CDX_0012 extends CritereGenererRapport {

	@Override
	public void validerSecurite(CardexAuthenticationSubject subject) {
		GestionnaireSecurite.validerSecuriteURL(subject, "/rapport/dossiersReperagesAccesInterditsNumero");
	}
	...
	public JRDataSource construireDataSource(CardexAuthenticationSubject subject, CritereRapportVO rapportVO, Connection connection) throws BusinessResourceException, BusinessException {
		...
		Collection liste = delegate.rapportReperageAccesInterdit(subject, rapportDossierVO, "CARDEX_RAPPORT.SP_RAP_REP_ACCES_INTERDITS");
	...
	protected InputStream obtenirGabarit() {
		return RapportsConfiguration.class.getResourceAsStream(RapportsConfiguration.REPERAGES_ACCES_INTERDITS);
	}
