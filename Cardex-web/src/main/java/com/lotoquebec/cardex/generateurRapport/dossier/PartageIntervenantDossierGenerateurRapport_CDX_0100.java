...
public class PartageIntervenantDossierGenerateurRapport_CDX_0100 extends CritereGenererRapport {
	...
	protected InputStream obtenirGabarit() {
		return RapportsConfiguration.class.getResourceAsStream(RapportsConfiguration.DOSSIER_PARTAGE_INTERVENANT);
	}
