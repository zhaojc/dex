...
public class NombrePlus5ReperageAutoexclusionGenerateurRapport_CDX_0011 extends CritereGenererRapport {

	@Override
	public void validerSecurite(CardexAuthenticationSubject subject) {
		GestionnaireSecurite.validerSecuriteURL(subject, "/rapport/dossiersReperages5PlusAutoexclusionNombre");
	}
	...
	public JRDataSource construireDataSource(CardexAuthenticationSubject subject, CritereRapportVO rapportVO, Connection connection) throws BusinessResourceException, BusinessException {
		...
		Collection liste = delegate.rapportReperageAutoexclusion(subject, rapportDossierVO, "CARDEX_RAPPORT.SP_RAP_REPERAGE_AU_TRI_NOMBRE", 5);
	...
	protected InputStream obtenirGabarit() {
		return RapportsConfiguration.class.getResourceAsStream(RapportsConfiguration.REPERAGES_AUTOEXCLUSIONS_PAR_NOMBRE);
	}
