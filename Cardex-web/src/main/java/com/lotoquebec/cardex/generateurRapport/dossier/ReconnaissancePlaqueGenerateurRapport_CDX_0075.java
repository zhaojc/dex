...
public class ReconnaissancePlaqueGenerateurRapport_CDX_0075 extends GenererRapport {
	...
	public JRDataSource construireDataSource(CardexAuthenticationSubject subject, RapportVO rapportVO, Connection connection) throws BusinessResourceException, BusinessException {
		...
		//Le syst�me AutoVu de reconnaissance de plaques supporte mal les accents. On les retire donc ici. Les autres l'ont d�j� �t� dans la proc�dure SQL. 
		if(natureDescription.equals("Acc�s interdits")){
			natureDescription = "Acces interdits";
		}
		if(siteDescription.equals("Casino Montr�al")){
