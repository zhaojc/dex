...
public class ComparatifAnnuelEnquetesDossierGenerateurRapport_CDX_0040 extends CritereGenererRapport {
    ...
    private List remplirCumul(ResultSet resultSet) {
		...
		try {
			// Le nombre d'entr�e retourn� est fixe. On traite chacune des
			// entr�es en fonction de la nature des enqu�tes.
			// Nature �v�nements
