...
public class NumeroReperageAutoexclusionDossierGenerateurRapport_CDX_0010 extends CritereGenererRapport {

	@Override
	public void validerSecurite(CardexAuthenticationSubject subject) {
		GestionnaireSecurite.validerSecuriteURL(subject, "/rapport/dossiersReperagesAutoexclusionNumero");
	}
	...
	public JRDataSource construireDataSource(CardexAuthenticationSubject subject, CritereRapportVO rapportVO, Connection connection) throws BusinessResourceException, BusinessException {
			...
			Collection liste  = delegate.rapportReperageAutoexclusion(subject, rapportDossierVO, "CARDEX_RAPPORT.SP_RAP_REPERAGE_AU_TRI_NUMERO", 1);
