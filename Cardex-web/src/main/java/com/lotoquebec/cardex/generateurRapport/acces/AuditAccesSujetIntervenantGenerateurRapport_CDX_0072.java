...
public class AuditAccesSujetIntervenantGenerateurRapport_CDX_0072 extends CritereGenererRapport {

	@Override
	public void validerSecurite(CardexAuthenticationSubject subject) {
		GestionnaireSecurite.validerSecuriteURL(subject, "/rapport/auditAccesSujetsIntervenant");
	}
