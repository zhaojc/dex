...
public class StatutDossierGenerateurRapport_CDX_0055 extends CritereGenererRapport {
	...
	protected Map construireParametres(CardexAuthenticationSubject subject, VO vo, Connection connection) throws JRException {
		...
		StatutDossierRapportVO_CDX_0055 statutDossierRapportVO_CDX_0055 = (StatutDossierRapportVO_CDX_0055) vo;
