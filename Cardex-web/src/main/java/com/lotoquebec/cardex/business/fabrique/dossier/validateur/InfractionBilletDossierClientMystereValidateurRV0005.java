...
/**
 * RV0005	Client mystère.  Un dossier d'infraction doit avoir au moins un billet.
 * 
 * @author levassc
 *
 */
public class InfractionBilletDossierClientMystereValidateurRV0005 implements Validateur<Dossier> {
   ...
   public BusinessMessage getMessage() throws BusinessResourceException {
		...
		return new BusinessMessage("ME0005", categorieDescription); //La catégorie du dossier «{0}» est erronée puisqu'il n'y a pas de billet.
   }
