...
public class SansNatureRAQRapportCDX_0070 extends RapportCDX_0070{

	private long nature;
	
	public SansNatureRAQRapportCDX_0070(CardexAuthenticationSubject subject, Date dateDebut, Date dateFin, long nature) {
	...
	protected List<RapportVOCDX_00070> construireDonneeRapport(CardexAuthenticationSubject subject, Date dateDebut, Date dateFin) throws DAOException{
		return FabriqueCardexDAO.getInstance().getRapportDAO().sansNatureRAQCDX_00070(subject, dateDebut, dateFin, nature);
	}
