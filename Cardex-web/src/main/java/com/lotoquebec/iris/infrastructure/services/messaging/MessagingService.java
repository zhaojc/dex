...
public interface MessagingService {
    ...
    /**
     *  <p>M�thode g�n�rique qui encapsule la couche de communication
	...
	/**
	 * <p>Envoie un message EAI en tant que message de statut � la destination sp�cifi�e.</p>
	 * 
	 * @param msg le message EAI qui va servir de message de statut
	 * @param destination la destination JMS vers laquelle va �tre envoy� le statut
	 * 
