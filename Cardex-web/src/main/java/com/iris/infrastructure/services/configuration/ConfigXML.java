package com.iris.infrastructure.services.configuration;
...
public class ConfigXML
{
	 ...
	 * 
	 * @return une instance de la classe à laquelle est associé l'EntityResolver
	 */
	...
	/**
	 * Permet de charger un document XML et de retourner son élément racine. Effectue la validation
	 * du contenue du document XML avec sa DTD si la méthode {@link #isValidating() isValidating} 
	 * retourne <code>true</code>.
	 * 
	 * @param fileName le nom du fichier qui doit être chargé
	 * 
	 ...
	 * retourne <code>true</code>.
	 * 
	 * @param stream le flux à partir duquel est chargé le fichier
	 * 
	...
	public Element loadDocument(InputStream stream) throws Exception
	{
		...
		try
		{
			...
			// Si on possède un EntityResolver, on le passe au parser
	...
	/**
	 * Permet de charger un document XML et de retourner son élément racine. N'effectue aucune 
	 * validation sur le contenue du document XML même si la méthode {@link #isValidating() isValidating} 
	 * retourne <code>true</code>.
	 * 
	...
	/**
	 * <p>Retourne l'instance de EntityResolver utilisée.</p>
	 * 
	...
	/**
	 * <p>Initialise l'instance de EntityResolver à utiliser.</p>
	 * 
	...
	/**
	 * Retourne <code>true</code> si le document XML à analyser doit être validé avec sa DTD,
	 * <code>false</code> sinon. La validation est désactivé par défaut.
	 * 
	 * @return 	<code>True</code> si le document XML à analyser doit être validé avec sa DTD,
	...
	/**
	 * Active la validation du document avec sa DTD si <code>validate</code> est à 
	 * <code>true</code>, et la désactive si <code>validate</code> est à <code>false</code>
	 * 
	 * @param validate 	Indique si la validation du document XML avec sa DTD doit être 
	 * 					activé (<code>true</code>) ou désactivé (<code>false</code>).
	 */
