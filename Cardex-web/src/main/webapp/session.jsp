...
Revision    : $Revision: 1.1 $, $Date: 2002/04/12 14:58:39 $
...
$Revision: 1.1 $, $Date: 2002/04/12 14:58:39 $, $Author: mlibersan $
      ...
      <table width="400" cellpadding="5" cellspacing="0" border="0"  bgcolor="#D0D0D0" class="darkOrangeOutline">
    		<tr>
              ...
              <TD class="errorHeader"><P align="justify">
                Votre session utilisateur est expirée ou inactive. Veuillez fermer et redémarrer l'application : ...
              </P></TD>
              <TD>&nbsp;</TD>
            <TR>
            ...
            <TR>
              <TD width="50" >&nbsp;</TD>
              <TD class="errorHeader"><P align="justify">
                Your user session is inactive or expired. Please close and restart the application : ...
             </P></TD>
             <TD>&nbsp;</TD>
            <TR>
