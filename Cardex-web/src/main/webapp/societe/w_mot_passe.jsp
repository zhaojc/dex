...
Revision    : $Revision: 1.2 $, $Date: 2002/04/23 21:08:57 $
...
$Revision: 1.2 $, $Date: 2002/04/23 21:08:57 $, $Author: mlibersan $
...
<html:form action='/societe/showAcces' >
      ...
      <table width="400" cellpadding="5" cellspacing="0" border="0"  bgcolor="#D0D0D0" class="tableOutline">
    		...
    		<tr>
    		  ...
    		  <table width="390" height="90" border="0" cellpadding="5" cellspacing="0" bgcolor="#ECECEC" class="tableCarved">
        		...
        		<tr>
        			<td width="195" align="right"><b><bean:message key='v_su_nom_t'/></b></td>
      		  ...
      		  <tr>
        			...
        			<td width="195" align="left">
        				<cardex:afficherValeurListeTag name='societe' property="site" classe='<%=GlobalConstants.CleListe.SITE_ORIGINE %>' actionSecurite='<%=GlobalConstants.ActionSecurite.SELECTION%>' />
        			</td>
      		  </tr>
      		  ...
      		  <tr>
        			...
        			<td width="195" align="left">
                                  <html:password name='societe' property="confirmationMotPasse" value="" maxlength="20" style="HEIGHT: 22px; WIDTH: 120px" />&nbsp;
                                  <html:hidden name='societe' property="motPasse"  />
    		...
    		<tr>
    		  <td width="200" align="right">
                     <cardex:button soumettre="/societe/showAcces.do" labelKey='cb_ok2' style="width: 60px; text-align: center;" />
                  </td>
