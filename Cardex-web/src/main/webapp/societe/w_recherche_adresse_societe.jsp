...
function doChoisir() {
	if (isChoixValide()){
		unlockFields();
	    soumettre('<%= request.getContextPath() + "/societe/adresse/choixRechercheAdresse.do"%>');
    }
}
...
function doCancel() {
	unlockFields();
    soumettre('<%=request.getContextPath()+"/societe/adresse/retourRechercheAdresse.do"%>');
}
...
<table align="center" height="550" border="0" cellpadding="5" cellspacing="0" bgcolor="#ffffff">
    <tr>
       <td align="center">
          ...
          <html:form action="/societe/adresse/rechercheAdresse" >
            <jsp:include page="/templates/adresses/tpl_recherche_validation_adresse_formulaire.jsp" flush="true" />
            
            <tiles:insert page="/templates/adresses/tpl_recherche_validation_adresse_formulaire.jsp" flush="true">
				<tiles:put name="soumettreRechercher" value="/societe/adresse/rechercheAdresse.do" />
				<tiles:put name="soumettreChoix" value="/societe/adresse/choixRechercheAdresse.do" />
			</tiles:insert>	
