<%-- --------------------------------------------------------------------------
Use case    : Affichage de l'adresse d'une société.
...
function doRefresh() {
	unlockFields();
    soumettre('<%= request.getContextPath() + "/societe/adresse/show/refresh.do"%>');
}
...
<table align="center" height="550" border="0" cellpadding="5" cellspacing="0" bgcolor="#ffffff">
    <tr>
       <td align="center">
          ...
          <html:form action="/societe/adresse/update" >
			<tiles:insert template='/templates/tpl_onglet_entete.jsp'>
          	...
          	<tiles:insert page="/templates/adresses/tpl_formulaire.jsp" flush="true">
          		<tiles:put name="soumettreURLSauvegarde" value="/societe/adresse/update.do" />
          		<tiles:put name="soumettreURLValidation" value="/societe/adresse/validationDefault.do" />
