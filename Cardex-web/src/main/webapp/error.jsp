      ...
      <table width="400" cellpadding="5" cellspacing="0" border="0"  bgcolor="#D0D0D0" class="darkOrangeOutline">
    		<tr>
              ...
              <TD class="errorHeader"><P align="justify">
                Une erreur système est survenue lors de la soumission de votre requête.Veuillez contactez votre administrateur : ...
              </P></TD>
              <TD>&nbsp;</TD>
            <TR>
            ...
            <TR>
              <TD width="50" >&nbsp;</TD>
              <TD class="errorHeader"><P align="justify">
                A system error occured while processing your request. Please contact your administrator: ...
             </P></TD>
             <TD>&nbsp;</TD>
            <TR>
