...
Revision    : $Revision: 1.4 $, $Date: 2002/04/24 12:31:52 $
...
$Revision: 1.4 $, $Date: 2002/04/24 12:31:52 $, $Author: mlibersan $
...
<SCRIPT language="JavaScript" type="text/javascript">
  function doClose() {
	parent.window.location='<cardex:writeObjectURL object="rechercheDossier" page="/vehicule/dossier/search/refresh.do" />';
  }

	function soumettreForm() {
		soumettre('<%= request.getContextPath() + "/vehicule/dossier/link.do"%>');
	}
...
<body  link="#095B97"
    leftmargin="5" rightmargin="0" topmargin="5" marginheight="5" marginwidth="5" >
                    <html:form action='/vehicule/dossier/link.do' >
