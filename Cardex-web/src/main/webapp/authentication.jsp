...
Revision    : $Revision: 1.1 $, $Date: 2002/04/12 14:58:33 $
...
$Revision: 1.1 $, $Date: 2002/04/12 14:58:33 $, $Author: mlibersan $
      ...
      <table width="400" cellpadding="5" cellspacing="0" border="0"  bgcolor="#D0D0D0" class="darkOrangeOutline">
    		<tr>
              ...
              <TD class="errorHeader"><P align="justify">
                Erreur d'authentification .Veuillez contactez votre administrateur : ...
              </P></TD>
              <TD>&nbsp;</TD>
            <TR>
            ...
            <TR>
              <TD width="50" >&nbsp;</TD>
              <TD class="errorHeader"><P align="justify">
                Authentification failed. Please contact your administrator: ...
             </P></TD>
             <TD>&nbsp;</TD>
            <TR>
