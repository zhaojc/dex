...
Revision    : $Revision: 1.2 $, $Date: 2002/04/23 21:08:49 $
...
$Revision: 1.2 $, $Date: 2002/04/23 21:08:49 $, $Author: mlibersan $
      ...
      <table width="400" cellpadding="5" cellspacing="0" border="0"  bgcolor="#D0D0D0" class="tableOutline">
    		...
    		<tr>
    		  ...
    		  <table width="390" height="90" border="0" cellpadding="5" cellspacing="0" bgcolor="#ECECEC" class="tableCarved">
        		...
        		<tr>
        			<td width="195" align="right"><b><bean:message key='l_dossier_no_t'/></b></td>
      		  ...
      		  <tr>
        			...
        			<td width="195" align="left">
        				<cardex:afficherValeurListeTag name='dossier' property="siteOrigine" classe='<%=GlobalConstants.CleListe.SITE_ORIGINE %>' actionSecurite='<%=GlobalConstants.ActionSecurite.SELECTION%>' />
        			</td>
      		  </tr>
      		  ...
      		  <tr>
        			...
        			<td width="195" align="left">
                                  <html:password name='dossier' property="confirmationMotPasse" value="" maxlength="20" style="HEIGHT: 22px; WIDTH: 120px" />&nbsp;
    		...
    		<tr>
    		  <td width="200" align="right">
                     <cardex:button soumettre="/dossier/showAcces.do" labelKey='cb_ok2' style="width: 80px; text-align: center;" />
                  </td>
