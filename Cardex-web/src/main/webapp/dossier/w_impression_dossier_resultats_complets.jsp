...
<TABLE width="650" cellpadding="0" cellspacing="0" border="0">
  <TR>
    ...
    <TD width="140" class="tabSubject">
		...
		valeurTableValeur='<%=GlobalConstants.TableValeur.NATURE %>' valeurDiscriminant='<%=genre%>'/>
    </TD>
...
<TABLE align="left" width="650" cellPadding="5" cellSpacing="0" bgcolor="#ffffff" border="0">
 <TR>
    <TD colspan="2"><b><bean:message key='st_rowcount_t2'/>&nbsp;<bean:write name='rechercheDossier' property='listeResultat.size'/></b></TD>
    </TR>
...
<logic:greaterThan name='rechercheDossier' property='listeResultat.size' value="0" >
	<TABLE align="left" width="650" cellPadding="0" cellSpacing="0" bgcolor="#ffffff" border="0">
	 <TR>
        ...
        <logic:iterate id='element' name='rechercheDossier' property='listeResultat.resultatComplet' >
               <TR>
