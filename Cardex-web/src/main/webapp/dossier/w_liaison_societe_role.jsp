...
<SCRIPT language="JavaScript" type="text/javascript">
  function doClose() {
	parent.window.location='<cardex:writeObjectURL object="rechercheSociete" page="/dossier/societe/search/refresh.do" />';
  }
	function soumettreForm() {
		soumettre('<%= request.getContextPath() + "/dossier/societe/link.do"%>');
	}
</SCRIPT>
...
<body  link="#095B97"
    leftmargin="5" rightmargin="0" topmargin="5" marginheight="5" marginwidth="5" >
                    ...
                    <html:form action='/dossier/societe/link.do' >
