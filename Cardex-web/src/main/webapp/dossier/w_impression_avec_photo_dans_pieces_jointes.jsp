    ...
    <TD width="650" valign="top">
      ...
      <TABLE width="650" cellpadding="2" cellspacing="0" border="0">
        ...
        <TR>
          ...
          <TD class="">
          		<bean:define id="categorie" name='<%=GlobalConstants.Impression.DOSSIER_KEY%>' property="type" type="String"/> 
    ...
    <TD width="650" valign="top">
      ...
      <TABLE width="650" cellpadding="2" cellspacing="0" border="0" >
        ...
        <TR>
          ...
          <TD width="170">
          		<cardex:afficherValeurListeTag name='<%=GlobalConstants.Impression.DOSSIER_KEY%>' property='siteOrigine' classe='<%=GlobalConstants.CleListe.SITE_ORIGINE %>' />      
          </TD>
        ...
        <TR>
          ...
          <TD class="">
                ...
                classe='<%= GlobalConstants.CleListe.TABLE_VALEUR_DISCRIMINANT_REQUIS %>' valeurDiscriminant='<%=entite %>' valeurTableValeur='<%=GlobalConstants.TableValeur.ORIGINE %>' 
      ...
      <TABLE width="650" cellpadding="2" cellspacing="0" border="0">
       <TR>
		  ...
		  <logic:present name='sujet' property='caracteristiques.doubleListe.droiteColLabel' >		  
            <TD width="1"><html:img page="/images/pixelgris.gif" width="1" height="125" border="0" /></TD>
            ...
            <TD align="left" valign="top">
              <TABLE cellpadding="2" cellspacing="0" border="0">
                 ...
                 <TR>
                    <TD width="27">&nbsp;</TD>
                    <TD><b><bean:message  locale='<%=GlobalConstants.Impression.LOCALE_KEY%>' key='caractéristiques_t'/></b></TD>
                 </TR>
                 <TR>
                    <TD width="27">&nbsp;</TD>
                    <TD>
    ...
    <TD align="center" colspan="3">
      <TABLE width="650" cellpadding="2" cellspacing="0" border="0">
        ...
        <TR>
          ...
          <TD width="160" >
            <cardex:afficherValeurListeTag classe='<%= GlobalConstants.CleListe.MODELE %>' name="vehicule" property="modele" valeurDiscriminant='<%=marque%>'/>
          </TD>
...
<!-- Pièces jointes -->
<P>
<logic:present name='<%=GlobalConstants.Impression.DOSSIER_KEY%>' property='piecesJointes'>
  <TABLE width="650" cellpadding="2" cellspacing="0"  rules="none">
    <TR>
      <TD class="errorHeader" >&nbsp;<bean:message  locale='<%=GlobalConstants.Impression.LOCALE_KEY%>' key='tabpage_documents_rapport' /></TD>
    </TR>
    ...
    <TR>
      <TD height="15"><html:img page="/images/pixelnoir.gif" width="650" height="2" border="0" /></TD>
        ...
        <!-- Les balises de paragraphes sont obligatoires -->
		<logic:iterate id="element" name='<%=GlobalConstants.Impression.DOSSIER_KEY%>' property='piecesJointes' indexId="index">
	    <TR>
	    <TD width="20" valign="top" class="tabSubject"><%=index.intValue()+1%></TD>
	    </TR>
	    <TR>
        <TD>
        	<logic:equal name="element" property="photo" value="true">
				<DIV align="center" STYLE="overflow:hidden; width:315; height:265;" >
		           <IMG src="<%= request.getContextPath() %>/AffichageLoupe?CLE=<bean:write name='element' property='lienElement' />&SITE=<bean:write name='element' property='lienSiteElement' />&EXTENSION=<bean:write name='element' property='extension' />" border="0" CLASS="tableOutline" alt="" onload="this.style.zoom='100%'; this.style.height='250'" >
				</DIV>
			</logic:equal>
        </TD>
	   </TR>
	   <TR>
	     <TD height="40" valign="top"><b><bean:write name="element" property="description"/></b>
	     </TD>
	   </TR>
	    <TR>
	      <TD align="center"><html:img page="/images/pixelgris.gif" width="648" height="1" border="0" /></TD>
	    </TR>
        </logic:iterate>
   <TR>
        <TD><P>&nbsp;</P></TD>
...
<TABLE width="650">
  <TR>
    <TD align='right'><b>CDX_0230</b></TD>
  </TR>
</TABLE>
