...
Revision    : $Revision: 1.6 $, $Date: 2002/04/24 12:31:50 $
...
$Revision: 1.6 $, $Date: 2002/04/24 12:31:50 $, $Author: mlibersan $
...
<SCRIPT language="JavaScript" type="text/javascript">
  function doClose() {
	parent.window.location='<cardex:writeObjectURL object="rechercheSujet" page="/dossier/sujet/search/refresh.do" />';
  }
	function soumettreForm() {
		soumettre('<%= request.getContextPath() + "/dossier/sujet/link.do"%>');
	}
</SCRIPT>
...
<body  link="#095B97"
    leftmargin="5" rightmargin="0" topmargin="5" marginheight="5" marginwidth="5" >
                    ...
                    <html:form action='/dossier/sujet/link.do' >
