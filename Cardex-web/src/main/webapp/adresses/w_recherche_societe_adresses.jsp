...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function doSoumettreRafraichir() {
	  //-- Fonction déclarée dans lq_scripts.js
		soumettre('<%= request.getContextPath() + "/adresses/rechercheSociete/rafraichir.do"%>');
	}

	function doPrint() {
		//-- Fonction déclarée dans lq_scripts.js
		//Impression de la page courante des résultats
	   var rapport = "<%= GlobalConstants.ChoixRapport.RESULTATS_RECHERCHE_ADRESSE_SOCIETES %>"; 
...
<html:form action='/adresses/soumettreRecherche' >
	...
	<jsp:include page="/templates/adresses/tpl_recherche_societe_adresses_resultats.jsp" flush="true" />
