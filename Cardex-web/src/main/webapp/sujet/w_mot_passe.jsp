...
Revision    : $Revision: 1.2 $, $Date: 2002/04/23 21:09:00 $
...
$Revision: 1.2 $, $Date: 2002/04/23 21:09:00 $, $Author: mlibersan $
...
<html:form action='/sujet/showAcces' >
      ...
      <table width="400" cellpadding="5" cellspacing="0" border="0"  bgcolor="#D0D0D0" class="tableOutline">
    		...
    		<tr>
    		  ...
    		  <table width="390" height="90" border="0" cellpadding="5" cellspacing="0" bgcolor="#ECECEC" class="tableCarved">
        		...
        		<tr>
        			<td width="195" align="right"><b><bean:message key='v_no_fiche_t'/></b></td>
      		  ...
      		  <tr>
        			...
        			<td width="195" align="left">
        				<cardex:afficherValeurListeTag name='sujet' property="site" classe='<%=GlobalConstants.CleListe.SITE_ORIGINE %>' actionSecurite='<%=GlobalConstants.ActionSecurite.SELECTION%>'/>
        			</td>
      		  </tr>
      		  ...
      		  <tr>
        			...
        			<td width="195" align="left">
                                  <html:password name='sujet' property="confirmationMotPasse" value="" maxlength="20" style="HEIGHT: 22px; WIDTH: 120px" />&nbsp;
                                  <html:hidden name='sujet' property="motPasse"  />
    		...
    		<tr>
    		  <td width="200" align="right">
                     <cardex:button soumettre="/sujet/showAcces.do" labelKey='cb_ok2' style="width: 60px; text-align: center;" />
                  </td>
