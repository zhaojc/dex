...
<SCRIPT language="JavaScript" type="text/javascript">
  function doClose() {
	parent.window.location='<cardex:writeObjectURL object="rechercheVehicule" page="/sujet/vehicule/search/refresh.do" />';
  }
	function soumettreForm() {
		soumettre('<%= request.getContextPath() + "/sujet/vehicule/link.do"%>');
	}
</SCRIPT>
...
<body  link="#095B97"
    leftmargin="5" rightmargin="0" topmargin="5" marginheight="5" marginwidth="5" >
                    ...
                    <html:form action='/sujet/vehicule/link.do' >
