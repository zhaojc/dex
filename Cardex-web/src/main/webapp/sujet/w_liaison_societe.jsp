...
function doReset() {
	soumettre('<%= request.getContextPath() + "/sujet/societe/search/reset/default.do"%>');
}

function doSoumettreRafraichir() {
	soumettre('<%= request.getContextPath() + "/sujet/societe/search/refresh.do"%>');
}
...
function doSearch() {
	soumettre('<%= request.getContextPath() + "/sujet/societe/search.do"%>');
}
...
function doClose() {
	window.location='<cardex:writeObjectURL object="rechercheSociete" objectProperty="sujet" page="/sujet/show.do" />';
}
...
<html:form action='/sujet/societe/search' >
        <html:hidden name='rechercheSociete' property='sujet.cle' />
        <html:hidden name='rechercheSociete' property='sujet.site' />
	...
	<tiles:insert page="/templates/societe/tpl_recherche_societe_formulaire.jsp" flush="true">
		<tiles:put name="urlSecuriteRecherche" value="/sujet/societe/search.do" />
	</tiles:insert>	
	
    <jsp:include page='/commun/aide.jsp' flush="true"/>
	<jsp:include page="/templates/tpl_erreur.jsp" flush="true" />
	<jsp:include page="/templates/sujet/tpl_liaison_societe_resultats.jsp" flush="true" />
