...
Revision    : $Revision: 1.4 $, $Date: 2002/04/19 20:00:18 $
...
function doRefresh() {
	unlockFields();
    soumettre('<%= request.getContextPath() + "/sujet/adresse/create/refresh.do"%>');
}
...
<table align="center" height="550" border="0" cellpadding="5" cellspacing="0" bgcolor="#ffffff">
    <tr>
       <td align="center">
          ...
          <html:form action="/sujet/adresse/add" >
			<tiles:insert template='/templates/tpl_onglet_entete.jsp'>
          	...
          	<tiles:insert page="/templates/adresses/tpl_formulaire.jsp" flush="true">
          		<tiles:put name="soumettreURLSauvegarde" value="/sujet/adresse/ajoutValidationDefault.do" />
