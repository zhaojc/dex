...
Revision    : $Revision: 1.5 $, $Date: 2002/04/24 12:31:54 $
...
$Revision: 1.5 $, $Date: 2002/04/24 12:31:54 $, $Author: mlibersan $
...
<SCRIPT language="JavaScript" type="text/javascript">
  function doClose() {
	parent.window.location='<cardex:writeObjectURL object="rechercheDossier" page="/sujet/dossier/search/refresh.do" />';
  }
	
	function soumettreForm() {
		soumettre('<%= request.getContextPath() + "/sujet/dossier/link.do"%>');
	}
...
<body  link="#095B97"
    leftmargin="5" rightmargin="0" topmargin="5" marginheight="5" marginwidth="5" >
                    <html:form action='/sujet/dossier/link.do' >
