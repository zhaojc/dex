...
<tiles:useAttribute name="soumettreRechercher" id="soumettreRechercher" classname="String"/>
<tiles:useAttribute name="soumettreChoix" id="soumettreChoix" classname="String"/>
      ...
      style="filter:progid:DXImageTransform.Microsoft.Gradient(endColorstr='#e6ebf4', startColorstr='#FFFFFF', gradientType='1');">
    		<TR>
                ...
                <TABLE width="300" cellpadding="2" cellspacing="0" border="0" style="border-style: solid;
                  border-color: #000000; border-width: 1px;">
              		<TR>
                    <TD align="center" class="tabSubject"><b><bean:message key='recherche.validation.adresse'/></b></TD>
                  </TR>
                </TABLE>
                <!-- END TITLE -->
      	...
      	<TR>
			...
			<TABLE width="600" cellpadding="3" cellspacing="0" border="0">
			  <TR>
			    <TD width="300">
                	<cardex:button urlSecurite='<%=soumettreChoix%>' labelKey='cb_choisir'  onclick='doChoisir();' style="color: #000000; width: 70px; text-align: center" />
                	<cardex:button soumettre='<%=soumettreRechercher %>' labelKey='cb_rechercher' style="color: #000000; width: 70px; text-align: center" />                	
                </TD>
