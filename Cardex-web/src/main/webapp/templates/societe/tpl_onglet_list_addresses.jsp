...
<DIV id="DATA_ADDRESS">
    ...
    <TR>
        ...
        <TD class="listTableHeader">
            <cardex:EnteteListeTriable name="societe" property="listeAdresses" key='<%=AdresseOngletTrieListe.CLE_SITE%>' URLTrier="/societe/trier.do"/>
        </TD>
        <TD class="listTableHeader">
            <cardex:EnteteListeTriable name="societe" property="listeAdresses" key='<%=AdresseOngletTrieListe.CLE_ADRESSE%>' URLTrier="/societe/trier.do"/>
        </TD>
        <TD class="listTableHeader">
            <cardex:EnteteListeTriable name="societe" property="listeAdresses" key='<%=AdresseOngletTrieListe.CLE_VILLE%>' URLTrier="/societe/trier.do"/>
        </TD>
        <TD class="listTableHeader">
            <cardex:EnteteListeTriable name="societe" property="listeAdresses" key='<%=AdresseOngletTrieListe.CLE_CODE_POSTAL%>' URLTrier="/societe/trier.do"/>
        </TD>
        <TD class="listTableHeader">
            <cardex:EnteteListeTriable name="societe" property="listeAdresses" key='<%=AdresseOngletTrieListe.CLE_TELEPHONE%>' URLTrier="/societe/trier.do"/>
        </TD>
        <TD class="listTableHeader">
            <cardex:EnteteListeTriable name="societe" property="listeAdresses" key='<%=AdresseOngletTrieListe.CLE_STATUT%>' URLTrier="/societe/trier.do"/>
        </TD>        
    </TR>
    <TR>
        <TD class="listDetailOdd" nowrap>
			<cardex:button labelKey="cb_ajouter" soumettre="/societe/adresse/ajouter.do"/>
        </TD>
    ...
    <TR>
        <TD class="listDetailOdd">
          <cardex:linkObject object='element' page='/societe/adresse/consulter.do'>
		  ...
		  <cardex:linkObject onclick="return doConfirmLinkSuppression();" object='element' page='/societe/adresse/delete.do'>
        ...
        <TD class="listDetailOdd" nowrap>
	        <bean:write name="element" property="adresseTag1"/><BR>
