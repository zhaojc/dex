...
Revision    : $Revision: 1.6 $, $Date: 2002/04/22 14:11:37 $
...
$Revision: 1.6 $, $Date: 2002/04/22 14:11:37 $, $Author: fguerin $
			 ...
			 <TR>
			   ...
			   <cardex:securityDefineTag nameDefine="cleSecurite" nomFormulaire="vehicule" propertyFormulaire='cle' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_CLE%>' URLTrier="/societe/vehicule/rechercheTrier.do"/>
				   </td>
				...
				<cardex:securityDefineTag nameDefine="immatriculationSecurite" nomFormulaire="vehicule" propertyFormulaire='immatriculation' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_IMMATRICULATION%>' URLTrier="/societe/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="marqueSecurite" nomFormulaire="vehicule" propertyFormulaire='marque' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_MARQUE%>' URLTrier="/societe/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="modeleSecurite" nomFormulaire="vehicule" propertyFormulaire='modele' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_MODELE%>' URLTrier="/societe/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="provinceSecurite" nomFormulaire="vehicule" propertyFormulaire='province' >				   
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_PROVINCE%>' URLTrier="/societe/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="anneeSecurite" nomFormulaire="vehicule" propertyFormulaire='annee' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_ANNEE%>' URLTrier="/societe/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
		    </TR>
			...
			<logic:iterate id='element' name='rechercheVehicule' property='listeResultat.resultatAffichage' >
               ...
               <TR>
                   <TD class="listDetailOdd">
                      <cardex:linkLiaisonVehicule source='rechercheVehicule' source='societe' vehicule='element' page='/societe/vehicule/link.do'>
	    ...
	    <TABLE align="left" width="770" cellPadding="5" cellSpacing="0" bgcolor="#ffffff" border="0">
	     <TR>
	       ...
	       <TD ALIGN="right" VALIGN="middle">
	    		<cardex:NavigationResultatListe name="rechercheVehicule" property="listeResultat" URLChangerPage="/societe/vehicule/rechercheChangerPage.do" />
	       </TD>
	      </TR>
	    </TABLE>
<!-- End Number of records to display -->
