...
Revision    : $Revision: 1.2 $, $Date: 2002/02/25 21:35:19 $
...
$Revision: 1.2 $, $Date: 2002/02/25 21:35:19 $, $Author: mdemers $
    ...
    <TD>
      ...
      <TABLE cellpadding="0" cellspacing="0" border="0">
        <TR>
          ...
          <TD CLASS="tabTitle" nowrap>&nbsp; <bean:message  key='tabpage_regroupement' /> &nbsp;</TD>
