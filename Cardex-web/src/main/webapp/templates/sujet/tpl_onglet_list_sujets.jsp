...
Revision    : $Revision: 1.10 $, $Date: 2002/04/04 20:40:19 $
...
$Revision: 1.10 $, $Date: 2002/04/04 20:40:19 $, $Author: mlibersan $
...
<DIV id="DATA_INDIVIDUALS">
    ...
    <TR>
        ...
        <cardex:securityDefineTag nameDefine="numeroFicheSecurite" nomFormulaire="sujet" propertyFormulaire='numeroFiche' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_NO_FICHE%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   ...
	   <cardex:securityDefineTag nameDefine="severiteAutresSecurite" nomFormulaire="sujet" propertyFormulaire='severiteAutres' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_SEVERITE_AUTRES%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="severiteSecurite" nomFormulaire="sujet" propertyFormulaire='severite' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_SEVERITE%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="severiteCasinoSecurite" nomFormulaire="sujet" propertyFormulaire='severiteCasino' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_SEVERITE_CASINO%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="nomSecurite" nomFormulaire="sujet" propertyFormulaire='nom' >
		   <TD class="listTableHeader">
		   		<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_NOM%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="prenomSecurite" nomFormulaire="sujet" propertyFormulaire='prenom' >
		   <TD class="listTableHeader">
		   		<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_PRENOM%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="sexeSecurite" nomFormulaire="sujet" propertyFormulaire='sexe' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_SEXE%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="ethnieSecurite" nomFormulaire="sujet" propertyFormulaire='ethnie' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_ETHNIE%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="raceSecurite" nomFormulaire="sujet" propertyFormulaire='race' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_RACE%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="langueSecurite" nomFormulaire="sujet" propertyFormulaire='langue' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_LANGUE%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="roleSecurite" nomFormulaire="sujet" propertyFormulaire='role' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_ROLE%>' URLTrier="/sujet/trier.do" />			   
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="lienCreateurSecurite" nomFormulaire="sujet" propertyFormulaire='lienCreateur' >
		   <TD class="listTableHeader">
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_LIEN_CREATEUR%>' URLTrier="/sujet/trier.do" />
		   </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="lienDateCreationSecurite" nomFormulaire="sujet" propertyFormulaire='lienDateCreation' >
		   <TD class="listTableHeader" >
				<cardex:EnteteListeTriable name="sujet" property="listeSujets" key='<%=SujetOngletTrieListe.CLE_DATE_LIAISON%>' URLTrier="/sujet/trier.do" />			   
		   </TD>
	   </cardex:securityDefineTag>
    </TR>
    ...
    <TR>
        <TD class="listDetailOdd" colspan="12" nowrap>
			<cardex:button labelKey="cb_lier" style="width: 50px; text-align: center;" soumettre="/sujet/sujet/search/show.do"/>
        </TD>
    </TR>    
    <logic:iterate id="element" name="sujet" property='sujets' indexId="index">
      <TR>
          <TD class="listDetailOdd" nowrap>
			...
			<logic:equal name='sujet' property='entite' value='<%= sujetEntite %>' >
			               <cardex:linkLiaisonSujet onclick="return doConfirmLinkSuppression();" source='sujet' sujet='element' page='/sujet/sujet/delete.do'>
	   ...
	   <logic:equal name="roleSecuriteHidden" value="false">	          
	          <TD class="listDetailOdd">
	               <bean:define id="sujetLien" name='sujet' property='<%="sujets["+index+"].lien"%>'/>
		           <bean:define id="sujetLienSite" name='sujet' property='<%="sujets["+index+"].lienSite"%>' type="String"/>
		           <myriap:select id='<%="sujets["+index+"].role"%>' name='element' property='role' style='HEIGHT: 20px; WIDTH: 120px'>
				   		<cardex:optionTag classe='<%= GlobalConstants.CleListe.TABLE_VALEUR_DISCRIMINANT_REQUIS %>' valeurDiscriminant='<%=sujetLienSite %>' valeurTableValeur='<%=GlobalConstants.TableValeur.ROLE_LIAISON_RELATION %>' actionSecurite='<%=GlobalConstants.ActionSecurite.TOUTES_ACTIONS %>'/>
		           </myriap:select>
		           &nbsp;
					<cardex:securityDefineTag nameDefine="sujetSujetSauvegarder" urlSecurite="/sujet/link/update.do">
