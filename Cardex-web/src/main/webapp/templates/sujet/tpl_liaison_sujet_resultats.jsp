...
Revision    : $Revision: 1.2 $, $Date: 2002/03/19 23:32:11 $
...
$Revision: 1.2 $, $Date: 2002/03/19 23:32:11 $, $Author: mlibersan $
...
<TABLE align="left" width="900" cellPadding="5" cellSpacing="0" bgcolor="#ffffff" border="0">
 <TR>
      <TD width="900"><b><bean:message key='st_rowcount_t2'/>&nbsp;<bean:write name='rechercheSujet' property='listeResultat.size'/></b></TD>
  </TR>
</TABLE>
			 ...
			 <TR>
			   <TD class="listTableHeader">&nbsp;</td>
				   ...
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_NO_FICHE%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
				...
				<cardex:securityDefineTag nameDefine="severiteAutreSecurite" nomFormulaire="sujet" propertyFormulaire='severiteAutres' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SEVERITE_AUTRES%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="severiteSecurite" nomFormulaire="sujet" propertyFormulaire='severite' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SEVERITE%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="severiteCasinoSecurite" nomFormulaire="sujet" propertyFormulaire='severiteCasino' >
                    <TD class="listTableHeader">
                    	<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SEVERITE_CASINO%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
                    </TD>
			   </cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="nomSecurite" nomFormulaire="sujet" propertyFormulaire='nom' >
				   <TD class="listTableHeader">
				   		<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_NOM%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="prenomSecurite" nomFormulaire="sujet" propertyFormulaire='prenom' >
				   <TD class="listTableHeader">
				   		<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_PRENOM%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="aliasSecurite" nomFormulaire="sujet" propertyFormulaire='alias' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SURNOM%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="sexeSecurite" nomFormulaire="sujet" propertyFormulaire='sexe' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SEXE%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="ethnieSecurite" nomFormulaire="sujet" propertyFormulaire='ethnie' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_ETHNIE%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="raceSecurite" nomFormulaire="sujet" propertyFormulaire='race' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_RACE%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="langueSecurite" nomFormulaire="sujet" propertyFormulaire='langue' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_LANGUE%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="dateNaissanceSecurite" nomFormulaire="sujet" propertyFormulaire='dateNaissance' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_DATE_NAISSANCE%>' URLTrier="/sujet/sujet/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
		    </TR>
            ...
            <logic:iterate id='element' name='rechercheSujet' property='listeResultat.resultatAffichage' >
               <TR>
                 <TD class="listDetailOdd">
                      <cardex:linkLiaisonSujet source='rechercheSujet' sourceProperty='sujet' sujet='element' page='/sujet/sujet/link/role/show.do'>
	    ...
	    <TABLE align="left" width="770" cellPadding="5" cellSpacing="0" bgcolor="#ffffff" border="0">
	     <TR>
	       ...
	       <TD ALIGN="right" VALIGN="middle">
	    		<cardex:NavigationResultatListe name="rechercheSujet" property="listeResultat" URLChangerPage="/sujet/sujet/rechercheChangerPage.do"/>
	       </TD>
	      </TR>
	    </TABLE>
<!-- End Number of records to display -->
