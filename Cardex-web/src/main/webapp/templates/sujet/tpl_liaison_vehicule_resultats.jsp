...
Revision    : $Revision: 1.3 $, $Date: 2002/04/22 14:11:34 $
...
$Revision: 1.3 $, $Date: 2002/04/22 14:11:34 $, $Author: fguerin $
...
<TABLE align="left" width="900" cellPadding="5" cellSpacing="0" bgcolor="#ffffff" border="0">
 <TR>
	    <TD width="900"><b><bean:message key='st_rowcount_t2'/>&nbsp;<bean:write name='rechercheVehicule' property='listeResultat.size'/></b></TD>
  </TR>
</TABLE>
			 ...
			 <TR>
			   ...
			   <cardex:securityDefineTag nameDefine="cleSecurite" nomFormulaire="vehicule" propertyFormulaire='cle' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_CLE%>' URLTrier="/sujet/vehicule/rechercheTrier.do"/>
				   </td>
				...
				<cardex:securityDefineTag nameDefine="immatriculationSecurite" nomFormulaire="vehicule" propertyFormulaire='immatriculation' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_IMMATRICULATION%>' URLTrier="/sujet/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="marqueSecurite" nomFormulaire="vehicule" propertyFormulaire='marque' >				   
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_MARQUE%>' URLTrier="/sujet/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="modeleSecurite" nomFormulaire="vehicule" propertyFormulaire='modele' >				   
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_MODELE%>' URLTrier="/sujet/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="provinceSecurite" nomFormulaire="vehicule" propertyFormulaire='province' >				   
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_PROVINCE%>' URLTrier="/sujet/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="anneeSecurite" nomFormulaire="vehicule" propertyFormulaire='annee' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheVehicule" property="listeResultat" key='<%=VehiculeTrieListe.CLE_ANNEE%>' URLTrier="/sujet/vehicule/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
		    </TR>
			...
			<logic:iterate id='element' name='rechercheVehicule' property='listeResultat.resultatAffichage' >
                 ...
                 <TR>
                       <TD class="listDetailOdd">
                          <cardex:linkLiaisonVehicule source='rechercheVehicule' source='sujet' vehicule='element' page='/sujet/vehicule/link.do'>
	    ...
	    <TABLE align="left" width="770" cellPadding="5" cellSpacing="0" bgcolor="#ffffff" border="0">
	     <TR>
	       ...
	       <TD ALIGN="right" VALIGN="middle">
	    		<cardex:NavigationResultatListe name="rechercheVehicule" property="listeResultat" URLChangerPage="/sujet/vehicule/rechercheChangerPage.do"/>
	       </TD>
	      </TR>
	    </TABLE>
<!-- End Number of records to display -->
