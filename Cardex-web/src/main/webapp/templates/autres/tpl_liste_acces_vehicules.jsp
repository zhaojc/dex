 ...
 <TR>
    <TD ALIGN="right" VALIGN="center">
      ...
      <logic:equal name='<%=GlobalConstants.RechercheList.ACCES_HAS_PREVIOUS%>' value='true'>
        <cardex:linkObject object='vehicule' page='/acces/searchVehicule/begin.do'>
          <b>|&lt;&lt;</b>
        </cardex:linkObject>
        ,
        <cardex:linkObject object='vehicule' page='/acces/searchVehicule/previous.do'>
          <b>&lt;&lt;</b>
        </cardex:linkObject>
      </logic:equal>
      ...
      <logic:equal name='<%=GlobalConstants.RechercheList.ACCES_HAS_NEXT%>' value='true'>
        <cardex:linkObject object='vehicule' page='/acces/searchVehicule/next.do'>
          <b>&gt;&gt;</b>
        </cardex:linkObject>
        ,
        <cardex:linkObject object='vehicule' page='/acces/searchVehicule/end.do'>
          <b>&gt;&gt;|</b>
        </cardex:linkObject>
      </logic:equal>
