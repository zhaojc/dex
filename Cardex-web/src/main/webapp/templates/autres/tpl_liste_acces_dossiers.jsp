 ...
 <TR>
    <TD ALIGN="right" VALIGN="middle">
      ...
      <logic:equal name='<%=GlobalConstants.RechercheList.ACCES_HAS_PREVIOUS%>' value='true'>
        <cardex:linkObject object='dossier' page='/acces/searchDossier/begin.do'>
          <b>|&lt;&lt;</b>
        </cardex:linkObject>
        ,
        <cardex:linkObject object='dossier' page='/acces/searchDossier/previous.do'>
          <b>&lt;&lt;</b>
        </cardex:linkObject>
      </logic:equal>
      ...
      <logic:equal name='<%=GlobalConstants.RechercheList.ACCES_HAS_NEXT%>' value='true'>
        <cardex:linkObject object='dossier' page='/acces/searchDossier/next.do'>
          <b>&gt;&gt;</b>
        </cardex:linkObject>
        ,
        <cardex:linkObject object='dossier' page='/acces/searchDossier/end.do'>
          <b>&gt;&gt;|</b>
        </cardex:linkObject>
      </logic:equal>
