	...
	<tr>
		<td align="right" width="200" ><b><bean:message key='du_t' /></b></td>
     	<td nowrap="nowrap" colspan="3" width="590" >
			<cardex:DateHeure name='<%=form%>' property='dateHeureDebutDu' calendrier="true" nomProchainChamp="dateDebutAu"/>
		</td>
	</tr>
	<tr>
		<td align="right" width="200" ><b><bean:message key='date_creation_fin_t' /></b></td>
     	<td nowrap="nowrap" colspan="3" width="590">
			<cardex:DateHeure name='<%=form%>' property='dateHeureDebutAu' calendrier="true" />
		</td>
	</tr>
