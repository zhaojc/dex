...
<TABLE width="680" cellpadding="3" cellspacing="0" border="0"
	...
	<TR>
	      ...
	      <td nowrap="nowrap" colspan="3">
	       ...
	       <myriap:select size='1' name='<%=form%>' property='nature' style='HEIGHT: 20px; WIDTH: 170px' tabindex="5" onchange="doSoumettreRafraichir();">
		   		   <cardex:optionTag classe='<%=GlobalConstants.CleListe.TABLE_VALEUR_DISCRIMINANT_REQUIS %>'
	...
	<TR>
	      ...
	      <td nowrap="nowrap" colspan="3">
	        ...
	        <myriap:select size='1' name='<%=form%>' property='type' style='HEIGHT: 20px; WIDTH: 170px' tabindex="6"  >
