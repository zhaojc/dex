...
<TABLE width="680" cellpadding="3" cellspacing="0" border="0"
	...
	<tr>
   		...
   		<TD ALIGN="left"><html:img page="/images/blank.gif" width="1" height="1" border="0" /><br>
			...
			<cardex:afficherValeurListeTag name="<%=form%>" property="entite" classe='<%=GlobalConstants.CleListe.ENTITE %>' actionSecurite='<%=GlobalConstants.ActionSecurite.RECHERCHE%>'/>
     	</TD>
        <TD ALIGN="right"><b><bean:message key='i_si_cle_t2'/></b></TD>
        <TD ALIGN="left">
			<cardex:afficherValeurListeTag name="<%=form%>" property="site" classe='<%=GlobalConstants.CleListe.SITE_ORIGINE %>' actionSecurite='<%=GlobalConstants.ActionSecurite.RECHERCHE%>'/>
		</TD>
    </tr>
   	<tr>
