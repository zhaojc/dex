...
<TABLE width="680" cellpadding="3" cellspacing="0" border="0"
	...
	<TR>
	  ...
	  <tr>
      		<td align="right" nowrap><b><bean:message key='groupe_t'/></b></td>
      		<td colspan="3">
        		<myriap:select name='<%=form%>' property="groupe" size="1" style="HEIGHT: 20px; WIDTH: 350px" tabindex="5" >
					<cardex:optionTag classe='<%=GlobalConstants.CleListe.GROUPE%>' />
        		</myriap:select>
            </td>
      </tr>
	<tr>
