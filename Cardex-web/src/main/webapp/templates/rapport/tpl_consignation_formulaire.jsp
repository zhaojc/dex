...
<TABLE width="680" cellpadding="3" cellspacing="0" border="0"
    ...
    <TR>
      ...
      <bean:define id="genre" name='<%=form%>' property="genre" type="String"/>
       <myriap:select size='1' name='<%=form%>' property='genre' style='HEIGHT: 20px; WIDTH: 200px' tabindex="4" onchange='doSoumettreRafraichir();' >
    ...
    <TR>
      ...
      <TD ALIGN="left">
       <myriap:select size='1' name='<%=form%>' property='nature' style='HEIGHT: 20px; WIDTH: 200px' tabindex="5" onchange="doSoumettreRafraichir();" >
	         <cardex:optionTag
    ...
    <TR>
      ...
      <TD ALIGN="left">
	    <bean:define id="nature" name='<%=form%>' property='nature' type="String"/>
        <myriap:select size='1' name='<%=form%>' property='type' style='HEIGHT: 20px; WIDTH: 200px' tabindex="6" onchange="doSoumettreRafraichir();" >
    ...
    <TR>
      ...
      <TD ALIGN="left" nowrap>
         ...
         <myriap:select size='1' name='<%=form%>' property='categorie' tabindex="7" style='HEIGHT: 20px; WIDTH: 200px' >
	...
	<TR>
      ...
      <td ALIGN="left" colspan="5">
       <bean:define id="site" name='<%=form%>' property="site" type="String"/>
       <myriap:select size="1" name='<%=form%>' property="intervenant" style="HEIGHT: 20px; WIDTH: 450px" tabindex="19" onkeypress="typeAhead(this, event);" onfocus="resetIncrementalSearch();">
