...
<TABLE width="680" cellpadding="3" cellspacing="0" border="0"
	...
	<tr>
		<td align="right" nowrap><b><bean:message key='regroupement.endroits' /><bean:message key='2.points' /></b></td>
     	<td colspan="3">
	        <myriap:select size='1' name='<%=form%>' property='regroupement' style='HEIGHT: 20px; WIDTH: 120px' tabindex="6"  >
				<cardex:optionTag classe='<%=GlobalConstants.CleListe.REGROUPEMENT_ENDROITS %>' />
	        </myriap:select>
		</td>
	</tr>
