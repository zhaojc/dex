...
Description : Écran utilisé pour associer une photo à partir d'un fichier ou d'un
	      numériseur
...
Sub PreviewImage()
    ...
    'document.links("Upload").attachEvent "onclick", getRef("soumettrePhoto();")
...
Sub doAnnoter()
	...
	ToolFont.name = "Times New Roman"
        ToolFont.Size = 14
        if document.forms(0).Preview.ImagHeight > 8000 then
           ToolFont.Size = 24
        end if
...
<table width="770" cellpadding="5" cellspacing="0" border="0" bgcolor="#EEEEEE" class="tableOutline">
    <tr>
        ...
        <table width="720" cellpadding="5" cellspacing="0" border="0" bgcolor="#D0D0D0" class="greenOutline">
            ...
            <td>
                <table width="275" height="75" border="0" cellpadding="10" cellspacing="0" bgcolor="#D0D0D0" class="greenOutline">
                    <tr>
                    <td>
                        <input type="button" name="connect" value="<bean:message key='numeriseur_t' />" onClick="Connection();photoLoad=true;assignerNumerisateur();" style="width='75'"/><BR><BR>
    					<html:file name="photo" property="sourceFile" onchange="assignerExtension(this.value);previsualiserEnable();"/>
                ...
                <tr>
                     <TD align="right"><input type="button" name="annotation" value="<bean:message key='annoter_t' />" style="width='75'" onClick="doAnnoter();" disabled/>
                         &nbsp;
                       	...
                       	<%-- onclick="soumettrePhoto();" --%>
					<TD bgcolor="#D0D0D0" align="right"><DIV id="VERY_TWISTED_BUTTON" style="width='75'"><A HREF="#" name="Upload"  
							style="color:#808080;"><bean:message key='associer_t' /></A></DIV>
					</TD>
                </tr>
                <tr>
				<TD align="right"><input type="button" name="appliquer" value="<bean:message key='appliquer_t' />" style="width='75'" onClick="doAppliquer();assignerUploader();" disabled>
				    &nbsp;
                 </TD>
                 <TD  align="right"><input type="button" name="Upload" style="width='75'" value="<bean:message key='annuler_t' />" onClick="doCancel();"/>
                 </TD>
                </tr>
                </table>
            </td>
