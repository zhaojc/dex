...
Revision    : $Revision: 1.1 $, $Date: 2002/03/26 22:18:16 $
...
$Revision: 1.1 $, $Date: 2002/03/26 22:18:16 $, $Author: mlibersan $
    ...
    <TD>
      ...
      <TABLE cellpadding="0" cellspacing="0" border="0">
        <TR>
          ...
          <TD CLASS="tabTitle" nowrap>&nbsp; <bean:message key='mandat_entete'/> &nbsp;</TD>
