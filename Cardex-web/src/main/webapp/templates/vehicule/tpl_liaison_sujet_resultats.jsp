...
Revision    : $Revision: 1.1 $, $Date: 2002/04/09 21:13:12 $
...
$Revision: 1.1 $, $Date: 2002/04/09 21:13:12 $, $Author: fguerin $
			 ...
			 <TR>
			   <TD class="listTableHeader">&nbsp;</TD>
				   ...
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_NO_FICHE%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
				...
				<cardex:securityDefineTag nameDefine="severiteAutreSecurite" nomFormulaire="sujet" propertyFormulaire='severiteAutres' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SEVERITE_AUTRES%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="severiteSecurite" nomFormulaire="sujet" propertyFormulaire='severite' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SEVERITE%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="severiteCasinoSecurite" nomFormulaire="sujet" propertyFormulaire='severiteCasino' >
                    <TD class="listTableHeader">
                    	<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SEVERITE_CASINO%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
                    </TD>
			   </cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="nomSecurite" nomFormulaire="sujet" propertyFormulaire='nom' >
				   <TD class="listTableHeader">
				   		<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_NOM%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="prenomSecurite" nomFormulaire="sujet" propertyFormulaire='prenom' >
				   <TD class="listTableHeader">
				   		<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_PRENOM%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="aliasSecurite" nomFormulaire="sujet" propertyFormulaire='alias' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SURNOM%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="sexeSecurite" nomFormulaire="sujet" propertyFormulaire='sexe' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_SEXE%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="ethnieSecurite" nomFormulaire="sujet" propertyFormulaire='ethnie' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_ETHNIE%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="raceSecurite" nomFormulaire="sujet" propertyFormulaire='race' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_RACE%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="langueSecurite" nomFormulaire="sujet" propertyFormulaire='langue' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_LANGUE%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="dateNaissanceSecurite" nomFormulaire="sujet" propertyFormulaire='dateNaissance' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_DATE_NAISSANCE%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>
				   </TD>
			   </cardex:securityDefineTag>
			   <cardex:securityDefineTag nameDefine="typeAgeSecurite" nomFormulaire="sujet" propertyFormulaire='typeAge' >
				   <TD class="listTableHeader">
						<cardex:EnteteListeTriable name="rechercheSujet" property="listeResultat" key='<%=SujetTrieListe.CLE_TYPE_AGE%>' URLTrier="/vehicule/sujet/rechercheTrier.do"/>		   
				   </TD>
			   </cardex:securityDefineTag>
		    </TR>
        ...
        <logic:iterate id='element' name='rechercheSujet' property='listeResultat.resultatAffichage' >                           
        	<TR>
                   <TD class="listDetailOdd">
                      <cardex:linkLiaisonSujet source='rechercheSujet' sourceProperty='vehicule' sujet='element' page='/vehicule/sujet/link.do'>
	    ...
	    <TABLE align="left" width="770" cellPadding="5" cellSpacing="0" bgcolor="#ffffff" border="0">
	     <TR>
	       ...
	       <TD ALIGN="right" VALIGN="middle">
	    		<cardex:NavigationResultatListe name="rechercheSujet" property="listeResultat" URLChangerPage="/vehicule/sujet/rechercheChangerPage.do"/>
	       </TD>
	      </TR>
	    </TABLE>
<!-- End Number of records to display -->
