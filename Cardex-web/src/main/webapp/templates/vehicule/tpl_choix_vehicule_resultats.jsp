...
<TABLE align="left" width="772" cellPadding="0" cellSpacing="0" bgcolor="#ffffff" border="1">
  <tr>
	    <TD class="listTableHeader2"><bean:message key='recherche.vehicules'/></TD>
  </TR>
  <tr>
...
<TABLE width="750" cellPadding="2" cellSpacing="10" border="0" >
<TR>
    <TD align="right">
		<cardex:button labelKey='cb_fermer'  onclick='doRetour();' style="color: #000000; width: 60px; text-align: center" />
    </TD>
</TR>
</TABLE>