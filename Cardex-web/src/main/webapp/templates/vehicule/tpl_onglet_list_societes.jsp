...
Revision    : $Revision: 1.6 $, $Date: 2002/04/12 19:43:06 $
...
$Revision: 1.6 $, $Date: 2002/04/12 19:43:06 $, $Author: fguerin $
    ...
    <TR>
       ...
       <cardex:securityDefineTag nameDefine="nomSecurite" nomFormulaire="societe" propertyFormulaire='nom' >
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="vehicule" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_NO_FICHE%>' URLTrier="/vehicule/trier.do" />
        </TD>
	   ...
	   <cardex:securityDefineTag nameDefine="severiteSecurite" nomFormulaire="societe" propertyFormulaire='severite' >        
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="vehicule" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_SEVERITE%>' URLTrier="/vehicule/trier.do" />
        </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="raisonEtreSecurite" nomFormulaire="societe" propertyFormulaire='raisonEtre' >        
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="vehicule" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_RAISON_SOCIALE%>' URLTrier="/vehicule/trier.do" />
        </TD>
   	  </cardex:securityDefineTag>
      <cardex:securityDefineTag nameDefine="nomSecurite" nomFormulaire="societe" propertyFormulaire='nom' >        
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="vehicule" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_NOM%>' URLTrier="/vehicule/trier.do" />
        </TD>
	  </cardex:securityDefineTag>
	  <cardex:securityDefineTag nameDefine="classeSecurite" nomFormulaire="societe" propertyFormulaire='classe' >        
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="vehicule" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_CLASSE%>' URLTrier="/vehicule/trier.do" />
        </TD>
	  </cardex:securityDefineTag>
	  <cardex:securityDefineTag nameDefine="roleSecurite" nomFormulaire="societe" propertyFormulaire='role' >        
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="vehicule" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_ROLE%>' URLTrier="/vehicule/trier.do" />
        </TD>
	  </cardex:securityDefineTag>
	  <cardex:securityDefineTag nameDefine="lienCreateurSecurite" nomFormulaire="societe" propertyFormulaire='lienCreateur' >        
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="vehicule" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_LIEN_CREATEUR%>' URLTrier="/vehicule/trier.do" />
        </TD>
      </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="lienDateCreationSecurite" nomFormulaire="societe" propertyFormulaire='lienDateCreation' >
		    <TD class="listTableHeader" >
				<cardex:EnteteListeTriable name="vehicule" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_DATE_LIAISON%>' URLTrier="/vehicule/trier.do" />			   
		    </TD>
 	   </cardex:securityDefineTag>
    </TR>
    <logic:greaterThan name="vehicule" property="listeSocietes.size" value="0">
	    <TR>
	       <TD colspan="9">
	   	      <b><bean:message key='st_rowcount_t4'/>&nbsp;<bean:write name='vehicule' property="listeSocietes.size"/></b>
	       </TD>
	    </TR>
    </logic:greaterThan>
    <TR>
        <TD class="listDetailOdd" colspan="8" nowrap>
			<cardex:button labelKey="cb_lier" style="width: 50px; text-align: center;" soumettre="/vehicule/societe/search/show.do"/>
        </TD>
    </TR>    
    <logic:iterate id="element" name="vehicule" property='societes' indexId="index">
        <TR>
           <TD class="listDetailOdd" nowrap>
				...
				<logic:equal name='vehicule' property='site' value='<%= sujetSite %>' >
					<cardex:linkLiaisonSociete onclick="return doConfirmLinkSuppression();"  source='vehicule' societe='element' page='/vehicule/societe/delete.do'>
	      ...
	      <logic:equal name="roleSecuriteHidden" value="false">	          
	          <TD class="listDetailOdd">
                    <bean:define id="societeLien" name='vehicule' property='<%="societes["+index+"].lien"%>'/>
                  	<bean:define id="societeLienSite" name='vehicule' property='<%="societes["+index+"].lienSite"%>' type="String" />
		           ...
		           &nbsp;
					<cardex:securityDefineTag nameDefine="vehiculeSocietesSauvegarder" urlSecurite="/vehicule/link/update.do">
