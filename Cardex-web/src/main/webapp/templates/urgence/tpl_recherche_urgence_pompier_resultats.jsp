...
Description : Module d'affichage représentant les résutlats de recherche d'un
              service d'urgence des pompiers.
			 ...
			 <TR>
			    <cardex:securityDefineTag nameDefine="classeSecurite" nomFormulaire="urgence" propertyFormulaire='classeDescription' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheUrgence" property="listeResultat" key='<%=UrgenceTrieListe.CLE_CLASSE%>' 
					   	URLTrier="/urgence/rechercheTrier.do" />
				   </td>
				...
				<cardex:securityDefineTag nameDefine="dossierSecurite" nomFormulaire="urgence" propertyFormulaire='numeroDossier' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheUrgence" property="listeResultat" key='<%=UrgenceTrieListe.CLE_DOSSIER%>' 
					   	URLTrier="/urgence/rechercheTrier.do" />
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="societeSecurite" nomFormulaire="urgence" propertyFormulaire='societe' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheUrgence" property="listeResultat" key='<%=UrgenceTrieListe.CLE_SOCIETE%>' 
					   	URLTrier="/urgence/rechercheTrier.do" />
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="contactSecurite" nomFormulaire="urgence" propertyFormulaire='contact' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheUrgence" property="listeResultat" key='<%=UrgenceTrieListe.CLE_CONTACT%>' 
					   	URLTrier="/urgence/rechercheTrier.do" />
				   </TD>
				</cardex:securityDefineTag>
				<cardex:securityDefineTag nameDefine="districtSecurite" nomFormulaire="urgence" propertyFormulaire='district' >
				   <TD class="listTableHeader">
					   <cardex:EnteteListeTriable name="rechercheUrgence" property="listeResultat" key='<%=UrgenceTrieListe.CLE_DISTRICT%>' 
					   	URLTrier="/urgence/rechercheTrier.do" />
				   </TD>
				</cardex:securityDefineTag>
		    </TR>
