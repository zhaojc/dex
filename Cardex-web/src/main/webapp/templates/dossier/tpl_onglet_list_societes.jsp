...
Revision    : $Revision: 1.9 $, $Date: 2002/04/25 17:41:34 $
...
$Revision: 1.9 $, $Date: 2002/04/25 17:41:34 $, $Author: mlibersan $
    ...
    <TR>
      ...
      <cardex:securityDefineTag nameDefine="nomSecurite" nomFormulaire="societe" propertyFormulaire='nom' >
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_NOM%>' URLTrier="/dossier/trier.do" />
        </TD>
	  </cardex:securityDefineTag>
       <cardex:securityDefineTag nameDefine="nomSecurite" nomFormulaire="societe" propertyFormulaire='nom' >
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_NO_FICHE%>' URLTrier="/dossier/trier.do" />
        </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="severiteSecurite" nomFormulaire="societe" propertyFormulaire='severite' >        
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_SEVERITE%>' URLTrier="/dossier/trier.do" />
        </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="severiteSecuriteCasino" nomFormulaire="societe" propertyFormulaire='severiteCasino' >        
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_SEVERITE_CASINO%>' URLTrier="/dossier/trier.do" />
        </TD>
	   </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="raisonEtreSecurite" nomFormulaire="societe" propertyFormulaire='raisonEtre' >
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_RAISON_SOCIALE%>' URLTrier="/dossier/trier.do" />
        </TD>
   	  </cardex:securityDefineTag>
	  <cardex:securityDefineTag nameDefine="classeSecurite" nomFormulaire="societe" propertyFormulaire='classe' >
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_CLASSE%>' URLTrier="/dossier/trier.do" />
        </TD>
	  </cardex:securityDefineTag>
	  <cardex:securityDefineTag nameDefine="roleSecurite" nomFormulaire="societe" propertyFormulaire='role' >
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_ROLE%>' URLTrier="/dossier/trier.do" />
        </TD>
	  </cardex:securityDefineTag>
	  <cardex:securityDefineTag nameDefine="lienCreateurSecurite" nomFormulaire="societe" propertyFormulaire='lienCreateur' >
        <TD class="listTableHeader">
        	<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_LIEN_CREATEUR%>' URLTrier="/dossier/trier.do" />
        </TD>
	  </cardex:securityDefineTag>
	   <cardex:securityDefineTag nameDefine="lienDateCreationSecurite" nomFormulaire="societe" propertyFormulaire='lienDateCreation' >
		   <TD class="listTableHeader" >
				<cardex:EnteteListeTriable name="dossier" property="listeSocietes" key='<%=SocieteOngletTrieListe.CLE_DATE_LIAISON%>' URLTrier="/dossier/trier.do" />			   
		   </TD>
	   </cardex:securityDefineTag>
    </TR>
    <logic:greaterThan name="dossier" property="listeSocietes.size" value="0">
    <TR>
       <TD colspan="14">&nbsp;
   	      <b><bean:message key='st_rowcount_t4'/>&nbsp;<bean:write name='dossier' property="listeSocietes.size"/></b>
       </TD>
    </TR>
    </logic:greaterThan>  
    <TR>
        <TD class="listDetailOdd" colspan="8" nowrap>
            <logic:notEqual name='dossier' property='statut' value='<%=GlobalConstants.Statut.DOSSIER_INACTIF%>' >
				<cardex:button labelKey="cb_lier" style="width: 50px; text-align: center;" soumettre="/dossier/societe/search/show.do"/>
            </logic:notEqual>
        </TD>
    </TR>      
    <logic:iterate id="element" name="dossier" property='societes' indexId="index">
        ...
        <TR>
           <TD class="listDetailOdd" nowrap>
            <logic:equal name='element' property="permettreSuppressionLiaison" value='true' >
                <cardex:linkLiaisonSociete onclick="return doConfirmLinkSuppression();"  source='dossier' societe='element' page='/dossier/societe/delete.do'>
            ...
            <logic:equal name="severiteSecuriteCasinoHidden" value="false">
           ...
           <logic:equal name="classeSecuriteHidden" value="false">	           
               ...
               <TD>
                   		<bean:define id="societeLien" name='dossier' property='<%="societes["+index+"].lien"%>'/>
                   		<bean:define id="societeLienSite" name='dossier' property='<%="societes["+index+"].lienSite"%>' type="String" />
			           ...
			           &nbsp;
			           <logic:notEqual name='dossier' property='statut' value='<%=GlobalConstants.Statut.DOSSIER_INACTIF%>' >
							<cardex:securityDefineTag nameDefine="dossierSocieteSauvegarder" urlSecurite="/dossier/link/update.do">
