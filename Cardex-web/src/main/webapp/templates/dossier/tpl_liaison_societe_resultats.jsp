...
Revision    : $Revision: 1.1 $, $Date: 2002/04/11 18:20:36 $
...
$Revision: 1.1 $, $Date: 2002/04/11 18:20:36 $, $Author: mlibersan $
	    ...
	    <!-- Data table -->
           <TABLE align="left" width="772" cellPadding="2" cellSpacing="0" border="1" >
                   <TR>
                    ...
                    <cardex:securityDefineTag nameDefine="nomSecurite" nomFormulaire="societe" propertyFormulaire='nom' >
	                    <TD class="listTableHeader">
	                    	<cardex:EnteteListeTriable name="rechercheSociete" property="listeResultat" key='<%=SocieteLiaisonTrieListe.CLE_NOM%>' URLTrier="/dossier/societe/rechercheTrier.do"/>
	                    </TD>
				   ...
				   <cardex:securityDefineTag nameDefine="classeSecurite" nomFormulaire="societe" propertyFormulaire='classe' >
	                    <TD class="listTableHeader">
	                    	<cardex:EnteteListeTriable name="rechercheSociete" property="listeResultat" key='<%=SocieteLiaisonTrieListe.CLE_CLASSE%>' URLTrier="/dossier/societe/rechercheTrier.do"/>
	                    </TD>
				   </cardex:securityDefineTag>
				   <cardex:securityDefineTag nameDefine="numeroFicheSecurite" nomFormulaire="societe" propertyFormulaire='numeroFiche' >
	                    <TD class="listTableHeader">
	                    	<cardex:EnteteListeTriable name="rechercheSociete" property="listeResultat" key='<%=SocieteLiaisonTrieListe.CLE_NO_FICHE%>' URLTrier="/dossier/societe/rechercheTrier.do"/>
	                    </TD>
				   </cardex:securityDefineTag>
				   <cardex:securityDefineTag nameDefine="severiteSecurite" nomFormulaire="societe" propertyFormulaire='severite' >
	                    <TD class="listTableHeader">
	                    	<cardex:EnteteListeTriable name="rechercheSociete" property="listeResultat" key='<%=SocieteLiaisonTrieListe.CLE_SEVERITE%>' URLTrier="/dossier/societe/rechercheTrier.do"/>
	                    </TD>
				   </cardex:securityDefineTag>
					   <cardex:securityDefineTag nameDefine="severiteCasinoSecurite" nomFormulaire="societe" propertyFormulaire='severiteCasino' >
	                    <TD class="listTableHeader">
	                    	<cardex:EnteteListeTriable name="rechercheSociete" property="listeResultat" key='<%=SocieteLiaisonTrieListe.CLE_SEVERITE_CASINO%>' URLTrier="/dossier/societe/rechercheTrier.do"/>
	                    </TD>
					   </cardex:securityDefineTag>
				   <cardex:securityDefineTag nameDefine="langueSecurite" nomFormulaire="societe" propertyFormulaire='langue' >
	                    <TD class="listTableHeader">
	                    	<cardex:EnteteListeTriable name="rechercheSociete" property="listeResultat" key='<%=SocieteLiaisonTrieListe.CLE_LANGUE%>' URLTrier="/dossier/societe/rechercheTrier.do"/>
	                    </TD>
				   </cardex:securityDefineTag>
				   <cardex:securityDefineTag nameDefine="raisonEtreSecurite" nomFormulaire="societe" propertyFormulaire='raisonEtre' >
	                    <TD class="listTableHeader">
	                    	<cardex:EnteteListeTriable name="rechercheSociete" property="listeResultat" key='<%=SocieteLiaisonTrieListe.CLE_RAISON_SOCIALE%>' URLTrier="/dossier/societe/rechercheTrier.do"/>
	                    </TD>
				   </cardex:securityDefineTag>
                   </TR>
                ...
                <logic:iterate id='element' name='rechercheSociete' property='listeResultat.resultatAffichage' >
                     ...
                     <TR>
                         <TD class="listDetailOdd">
                            <cardex:linkLiaisonSociete source='rechercheSociete' sourceProperty='dossier' societe='element' page='/dossier/societe/link/role/show.do'>
    ...
    <TABLE align="left" width="770" cellPadding="5" cellSpacing="0" bgcolor="#ffffff" border="0">
     <TR>
       ...
       <TD ALIGN="right" VALIGN="middle">
    		<cardex:NavigationResultatListe name="rechercheSociete" property="listeResultat" URLChangerPage="/dossier/societe/rechercheChangerPage.do" />
       </TD>
      </TR>
    </TABLE>
<!-- End Number of records to display -->
