...
<tiles:useAttribute name="urlSecuriteApprobation" id="urlSecuriteApprobation" classname="String"/>
<tiles:useAttribute name="urlSecuriteModification" id="urlSecuriteModification" classname="String"/>
    ...
    style="filter:progid:DXImageTransform.Microsoft.Gradient(endColorstr='#ACC8CC', startColorstr='#FFFFFF', gradientType='0');" bgcolor="#acc8c8">
        <tr>
            ...
            <td>
              <logic:equal name='narration' property='modifiable' value='true' >
                 <cardex:argent name='narration' 
					property='montant' size="11" maxlength='11'  style="HEIGHT: 20px; WIDTH: 65px" />$
              </logic:equal>
              <logic:equal name='narration' property='modifiable' value='false' >
                 <bean:write name='narration' property="montant" />
                 <html:hidden name='narration' property="montant" />
              </logic:equal>
            </td>
            <td colspan="2">&nbsp;</td>
            ...
            <td>
              ...
              <logic:equal name='narration' property='modifiable' value='false' >
              	<cardex:afficherValeurListeTag name='narration' property="confidentialiteNarration" classe='<%=GlobalConstants.CleListe.TABLE_VALEUR %>' valeurTableValeur='<%=GlobalConstants.TableValeur.CONFIDENTIALITE%>' actionSecurite='<%=actionSecurite%>'/>
              </logic:equal>
            </td>
        <tr>
        ...
        <tr>
            ...
            <td nowrap="nowrap" colspan="3">
              ...
              <logic:equal name='narration' property='modifiable' value='false' >
                ...
                <html:hidden name='narration' property="tempsConsacre" />
              </logic:equal>
            ...
            <td> 
                <myriap:select name='narration' property="reference" size="1" style="HEIGHT: 20px; WIDTH: 115px" onkeypress="typeAhead(this, event);" onfocus="resetIncrementalSearch();" >
        ...
        <tr>
            ...
            <TR>
            	<td colspan="5">
            	 	<!-- Selon le sujet ou le dossier, on affiche une information différente. -->
            	 	<logic:greaterThan name="narration" property="dossier.cle" value="0">
					...
					<html:hidden  name="narration" property="sujet.cle" />
            	 	<logic:greaterThan name="narration" property="sujet.cle" value="0">
            	 		<bean:define id="sujet" name='sujet'/>
		            	<b><bean:message key='v_no_fiche_t'/></b>
            ...
            <td align="center" colspan="6" width="1100">
              ...
              <TABLE width="740" cellpadding="2" cellspacing="0" border="0">
                <TR>
                  <TD>
                    <logic:equal name='narration' property='modifiable' value='true' >
                      <cardex:button urlSecurite='<%=urlSecuriteSauvegarde %>' labelKey='cb_ok' style="width: 70px; text-align: center;"
                        onclick='doOk();' />
                    </logic:equal>
                    <logic:equal name='narration' property='modifiable' value='false' >
                ...
                <TD>&nbsp;
		    		...
		    		<cardex:button labelKey='cb_spellcheck' style="width: 70px; text-align: center;" onclick="jspellcheck()" />
				</TD>
                <TD>
                    <logic:equal name='narration' property='approuvable' value='true' >
                        <cardex:button urlSecurite='<%=urlSecuriteApprobation%>' labelKey='cb_approbation' style="width: 70px; text-align: center;" onclick='doApprobation();' />
                    </logic:equal>
                ...
                <TD>
                    <logic:equal name='narration' property='permettreModification' value='true' >
                      <cardex:button urlSecurite='<%=urlSecuriteModification %>' labelKey='cb_modification' style='width: 110px' onclick='doModification();'  />
                    </logic:equal>
                ...
                <TD>
                    ...
                    <cardex:button labelKey='cb_annuler' style="width: 50px; text-align: center;" onclick='doCancel();' />
                </TD>
              </TR>
            </TABLE>
            <!-- END BOTTOM BUTTONS -->
