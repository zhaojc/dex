 ...
 <TABLE width="652" cellpadding="2" cellspacing="0" border="0" class="pictureBackground" style="border-style: double; border-color: #000000;">
  <TR>
    ...
    <TD width="230" align="right" valign="bottom" class="errorHeader">
      <bean:message key='v_su_numero_t'/>&nbsp;
    </TD>
  ...
  <TR>
    <TD width="302">&nbsp;</TD>
    <TD width="230" align="right" valign="bottom" class="errorHeader"><bean:message key='v_su_nom_t'/>&nbsp;   </TD>
    <TD width="120" valign="top" style="border-style: none; background-color: #eeeeee;" >
         <bean:write name='narration' property='reference2'/>
    </TD>
  </TR>
  <TR>
    <TD width="302">&nbsp;</TD>
    <TD width="230" align="right" valign="bottom" class="errorHeader"><bean:message key='v_su_prenom_t'/>&nbsp;   </TD>
    <TD width="120" valign="top" style="border-style: none; background-color: #eeeeee;" >
         <bean:write name='narration' property='reference3'/>
    </TD>
  </TR>
 </TABLE>
 <br>
