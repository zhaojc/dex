...
Revision    : $Revision: 1.1 $, $Date: 2002/02/22 17:51:20 $
...
$Revision: 1.1 $, $Date: 2002/02/22 17:51:20 $, $Author: mdemers $
    ...
    <TD>
      ...
      <TABLE cellpadding="0" cellspacing="0" border="0">
        <TR>
          ...
          <TD CLASS="tabTitle" nowrap>&nbsp; <bean:message key='tabpage_commentaire'/> &nbsp;</TD>
