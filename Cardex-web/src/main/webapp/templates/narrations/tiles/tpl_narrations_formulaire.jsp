    ...
    style="filter:progid:DXImageTransform.Microsoft.Gradient(endColorstr='#ACC8CC', startColorstr='#FFFFFF', gradientType='0');" bgcolor="#acc8c8">
        ...
        <tr>
            ...
            <bean:message key='total_minutes_t'/>
				&nbsp;
            	<logic:greaterThan name='narration' property="tempsConsacreHeure" value="0">
	                <bean:write name='narration' property="tempsConsacreHeure" />
	            	<bean:message key='heures_t'/>
            	</logic:greaterThan>            	
				&nbsp;
            	<bean:write name='narration' property="tempsConsacreMinute" />
...
<SCRIPT language="JavaScript">
   ...
   enregistrerNarrationTemporaire();
