...
<SCRIPT language="JavaScript" type="text/javascript">
  function doPrint(){
    ...
    parent.frames('piece_content').Imprimer();
    parent.frames('piece_content').print();
    parent.frames('piece_content').ApresImpression();
  }

  function doClose() {
	parent.window.location='<%= request.getContextPath() %>/galerie/w_consultation_galerie.jsp';
  }
...
<TABLE width="700" cellpadding="0" cellspacing="0" border="0" bgcolor="#009999" class="tableOutline">
  <TR>
    <TD>
    <table width="700" cellpadding="5" cellspacing="0" border="0">
        <TR>
           <TD><html:img page="/images/blank.gif" width="700" height="1" border="0" /></TD>
        </TR>
